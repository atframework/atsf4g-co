...
namespace rpc {
    namespace details {
        ...
        inline int __setup_rpc_stream_header(hello::SSMsgHead &head, const char *rpc_full_name, const std::string &type_full_name) {
    ...
    namespace router {
        ...
        routerservice_result_t router_update_sync(context &__ctx, uint64_t dst_bus_id, hello::SSRouterUpdateSync &req_body) {
            ...
            res = details::__setup_rpc_stream_header(*req_msg.mutable_head(), "hello.RouterService.router_update_sync",
            ...
            if (res < 0) {
                FWLOGERROR("rpc {} call failed, res: {}({})", "hello.RouterService.router_update_sync", res, protobuf_mini_dumper_get_error_msg(res));
            }
            return routerservice_result_t(__tracer.return_code(res));
        }

        // ============ hello.RouterService.router_transfer ============
        routerservice_result_t router_transfer(context &__ctx, uint64_t dst_bus_id, hello::SSRouterTransferReq &req_body,
            ...
            hello::SSMsg &req_msg = *req_msg_ptr;
            task_action_ss_req_base::init_msg(req_msg, logic_config::me()->get_self_bus_id());
            res = details::__setup_rpc_request_header(*req_msg.mutable_head(), *task, "hello.RouterService.router_transfer",
            ...
            if (res < 0) {
                FWLOGERROR("rpc {} call failed, res: {}({})", "hello.RouterService.router_transfer", res, protobuf_mini_dumper_get_error_msg(res));
            }
