...
SERVER_FRAME_API int32_t rpc_get_not_ready_code();
...
#define RPC_RESULT_TYPE_DECL(...) ATFW_EXPLICIT_NODISCARD_ATTR ::rpc::rpc_result<__VA_ARGS__>
#define RPC_RESULT_CODE_DECL ATFW_EXPLICIT_NODISCARD_ATTR ::rpc::result_code_type
#define RPC_RESULT_VOID_DECL ATFW_EXPLICIT_NODISCARD_ATTR ::rpc::result_void_type
