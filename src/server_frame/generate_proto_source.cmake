...
function(project_server_frame_create_protocol_target TARGET_NAME SANDBOX_PATH OUTPUT_HEAD_VAR OUTPUT_SOURCE_VAR)
  ...
  foreach(FILE_PATH IN LISTS project_server_frame_create_protocol_target_PROTOCOLS)
    ...
    if(NOT "${FILE_RELATIVE_DIR}" STREQUAL "${LAST_CREATED_DIRECTORY}")
      if(LAST_DIRECTORY_HEADERS)
        list(
          ...
          "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/include/${LAST_CREATED_DIRECTORY}")
      endif()
      if(LAST_DIRECTORY_SOURCES)
        list(
          ...
          "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/src/${LAST_CREATED_DIRECTORY}")
      endif()

      set(LAST_CREATED_DIRECTORY "${FILE_RELATIVE_DIR}")
      if(NOT EXISTS "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/include/${LAST_CREATED_DIRECTORY}")
        file(MAKE_DIRECTORY "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/include/${LAST_CREATED_DIRECTORY}")
      endif()
      if(NOT EXISTS "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/src/${LAST_CREATED_DIRECTORY}")
        file(MAKE_DIRECTORY "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/src/${LAST_CREATED_DIRECTORY}")
      endif()
    endif()
    ...
    list(APPEND HEADERS "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/include/${FILE_RELATIVE_BASE}.pb.h")
    list(APPEND SOURCES "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/src/${FILE_RELATIVE_BASE}.pb.cc")
  endforeach()
  if(LAST_DIRECTORY_HEADERS)
    list(
      APPEND
...
install(
  DIRECTORY "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/include/protocol"
  DESTINATION "include"
