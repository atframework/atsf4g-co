...
project_server_frame_create_protocol_sandbox(
  "PROTOCOL_SANDBOX_TARGET_extension" "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_EXTENSION_DIR}/protocol/extension"
...
project_server_frame_create_protocol_sandbox(
  "PROTOCOL_SANDBOX_TARGET_common" "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_COMMON_DIR}/protocol/common"
  PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_COMMON ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_COMMON})
...
project_server_frame_create_protocol_sandbox(
  "PROTOCOL_SANDBOX_TARGET_config" "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_CONFIG_DIR}/protocol/config"
  PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_CONFIG ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_CONFIG}
...
file(GLOB PROJECT_RESOURCE_EXCEL_FILES_ORIGIN "${PROJECT_THIRD_PARTY_XRESLOADER_EXCEL_DIR}/*.xlsx")
unset(PROJECT_RESOURCE_EXCEL_FILES)
foreach(EXCEL_FILE IN LISTS PROJECT_RESOURCE_EXCEL_FILES_ORIGIN)
  if(NOT EXCEL_FILE MATCHES ".*~\\$[^/\\\\]*$")
    list(APPEND PROJECT_RESOURCE_EXCEL_FILES "${EXCEL_FILE}")
  endif()
endforeach()
...
file(
  APPEND "${CMAKE_CURRENT_BINARY_DIR}/generate-excel-bytes.sh"
...
project_server_frame_create_protocol_sandbox(
  "PROTOCOL_SANDBOX_TARGET_pbdesc" "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_PBDESC_DIR}/protocol/pbdesc"
  PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_PBDESC ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_PBDESC})
...
project_server_frame_create_protocol_sandbox(
  "PROTOCOL_SANDBOX_TARGET_log" "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LOG_DIR}/protocol/log"
  PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_LOG ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_LOG})
list(REMOVE_DUPLICATES PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_LOG)

project_server_frame_create_protocol_target(
  protocol-log
  "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LOG_DIR}"
...
execute_process(
  COMMAND
    ...
    "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_EXTENSION_DIR}" --proto_path
    "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_COMMON_DIR}" --proto_path "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_CONFIG_DIR}"
    --proto_path "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LOG_DIR}" --proto_path
    "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_PBDESC_DIR}" --proto_path "${PROJECT_THIRD_PARTY_PROTOBUF_PROTO_DIR}"
    --proto_path "${ATFRAMEWORK_LIBATBUS_REPO_DIR}/include" --proto_path "${ATFRAMEWORK_LIBATAPP_REPO_DIR}/include" -o
    "${PROJECT_GENERATED_PBD_DIR}/serverframe_all.pb"
    # Protocol buffer files
    ${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_CONFIG} ${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_COMMON}
    ${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_EXTENSION} ${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_PBDESC}
    ${PROJECT_SERVER_FRAME_PROTO_SANDBOX_LIST_LOG} "${ATFRAMEWORK_LIBATAPP_REPO_DIR}/include/atframe/atapp_conf.proto"
    "${ATFRAMEWORK_LIBATBUS_REPO_DIR}/include/libatbus_protocol.proto"
    "${PROJECT_THIRD_PARTY_PROTOBUF_PROTO_DIR}/google/protobuf/any.proto"
    "${PROJECT_THIRD_PARTY_PROTOBUF_PROTO_DIR}/google/protobuf/empty.proto"
    "${PROJECT_THIRD_PARTY_PROTOBUF_PROTO_DIR}/google/protobuf/duration.proto"
...
add_custom_command(
  ...
  COMMAND
    ...
    "${PROJECT_THIRD_PARTY_PROTOBUF_PROTO_DIR}/google/protobuf/descriptor.proto"
  WORKING_DIRECTORY "${PROJECT_SERVER_FRAME_PROTO_SANDBOX_PBDESC_DIR}"
  DEPENDS ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_EXTENSION}
          ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_COMMON}
          ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_CONFIG}
          ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_PBDESC}
          ${PROJECT_SERVER_FRAME_PROTO_ORIGIN_LIST_LOG}
...
add_custom_command(
  ...
  COMMENT
    "Generate [@${PROJECT_SERVER_FRAME_PROTO_SANDBOX_PBDESC_DIR}] ${PROJECT_INSTALL_RES_PBD_DIR}/serverframe_all.pb")
