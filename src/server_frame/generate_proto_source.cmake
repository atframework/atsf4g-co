...
if(PROTO_DESC_LIST_COMMON)
  ...
  list(APPEND SRC_LIST ${PROJECT_SERVER_FRAME_PROTO_SRCS})

  add_custom_command(
    OUTPUT ${PROJECT_SERVER_FRAME_PROTO_SRCS}
    COMMAND
      "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_BIN_PROTOC}" --proto_path
      "${PROJECT_SERVER_FRAME_PROTO_RELATIVE_DIR}" --proto_path "${PROJECT_THIRD_PARTY_INSTALL_DIR}/include"
      --cpp_out "${PROJECT_SERVER_FRAME_PROTO_GENERATED_COMMON_DIR}"
...
add_custom_command(
  ...
  COMMAND
    "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_BIN_PROTOC}" --proto_path
    "${PROJECT_SERVER_FRAME_PROTO_RELATIVE_DIR}" --proto_path "${PROJECT_SERVER_FRAME_PROTOCOL_DIR}/common"
    --proto_path "${PROJECT_THIRD_PARTY_INSTALL_DIR}/include" --proto_path
...
add_custom_command(
  ...
  COMMAND
    ...
    # Protocol buffer files
    ${PROTO_DESC_LIST_PBDESC} ${PROTO_DESC_LIST_COMMON}
    "${ATFRAMEWORK_LIBATAPP_REPO_DIR}/include/atframe/atapp_conf.proto"
    "${ATFRAMEWORK_LIBATBUS_REPO_DIR}/include/libatbus_protocol.proto"
    "${PROJECT_THIRD_PARTY_INSTALL_DIR}/include/google/protobuf/duration.proto"
    "${PROJECT_THIRD_PARTY_INSTALL_DIR}/include/google/protobuf/timestamp.proto"
