...
foreach(GENERATED_FILE ${PROJECT_SERVER_FRAME_PROTO_SRCS} "${PROJECT_INSTALL_RES_PBD_DIR}/config.pb")
  if(EXISTS "${GENERATED_FILE}")
    project_make_writable("${GENERATED_FILE}")
  endif()
endforeach()
...
foreach(GENERATED_FILE ${PROJECT_SERVER_FRAME_PROTO_SRCS})
  if(EXISTS "${GENERATED_FILE}")
    project_make_writable("${GENERATED_FILE}")
  endif()
endforeach()
