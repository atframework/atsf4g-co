...
struct ATFW_UTIL_SYMBOL_VISIBLE user_key_hash_t {
  size_t operator()(const PROJECT_NAMESPACE_ID::DUserIDKey& key) const {
    uint64_t out[2] = {0};
...
struct ATFW_UTIL_SYMBOL_VISIBLE user_key_equal_t {
