...
task_action_router_transfer::task_action_router_transfer(dispatcher_start_data_t COPP_MACRO_RV_REF param) : base_type(COPP_MACRO_STD_MOVE(param)) {}
task_action_router_transfer::~task_action_router_transfer() {}

bool task_action_router_transfer::is_stream_rpc() const {
    return false;
}
