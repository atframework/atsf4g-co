...
task_action_router_update_sync::task_action_router_update_sync(dispatcher_start_data_t COPP_MACRO_RV_REF param) : base_type(COPP_MACRO_STD_MOVE(param)) {}
task_action_router_update_sync::~task_action_router_update_sync() {}

bool task_action_router_update_sync::is_stream_rpc() const {
    return true;
}
