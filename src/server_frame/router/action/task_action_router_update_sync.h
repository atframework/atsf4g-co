...
class task_action_router_update_sync : public task_action_ss_rpc_base<hello::SSRouterUpdateSync, google::protobuf::Empty> {
public:
#if defined(UTIL_CONFIG_COMPILER_CXX_RVALUE_REFERENCES) && UTIL_CONFIG_COMPILER_CXX_RVALUE_REFERENCES
    using base_type = task_action_ss_rpc_base<hello::SSRouterUpdateSync, google::protobuf::Empty>;
...
#else
    typedef task_action_ss_rpc_base<hello::SSRouterUpdateSync, google::protobuf::Empty> base_type;
...
public:
    task_action_router_update_sync(dispatcher_start_data_t COPP_MACRO_RV_REF param);
