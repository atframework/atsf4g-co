...
class task_action_router_transfer : public task_action_ss_rpc_base<hello::SSRouterTransferReq, hello::SSRouterTransferRsp> {
public:
...
#else
    typedef task_action_ss_rpc_base<hello::SSRouterTransferReq, hello::SSRouterTransferRsp> base_type;
...
public:
    task_action_router_transfer(dispatcher_start_data_t COPP_MACRO_RV_REF param);
