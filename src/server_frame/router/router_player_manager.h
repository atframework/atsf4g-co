...
#  endif
 ...
 private:
  ATFW_EXPLICIT_NODISCARD_ATTR rpc::result_code_type on_evt_remove_object(rpc::context &ctx, const key_t &key,
                                                                          const ptr_t &cache,
                                                                          priv_data_t priv_data) override;

  ATFW_EXPLICIT_NODISCARD_ATTR rpc::result_code_type on_evt_object_removed(rpc::context &ctx, const key_t &key,
                                                                           const ptr_t &cache,
                                                                           priv_data_t priv_data) override;
