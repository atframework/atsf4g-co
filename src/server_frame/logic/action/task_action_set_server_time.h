...
class task_action_set_server_time
    : public task_action_ss_rpc_base<PROJECT_NAMESPACE_ID::SSGlobalLogicSetServerTimeSync, google::protobuf::Empty> {
 public:
  using base_type =
      task_action_ss_rpc_base<PROJECT_NAMESPACE_ID::SSGlobalLogicSetServerTimeSync, google::protobuf::Empty>;
 ...
 public:
  explicit task_action_set_server_time(dispatcher_start_data_type&& param);
