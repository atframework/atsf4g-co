...
function(project_server_frame_add_config_target)
  ...
  set(PROJECT_SERVER_FRAME_CONFIG_GENERATE_EXCEL_CONFIG_LOADER_COMMAND
      "${PROJECT_SERVER_FRAME_CONFIG_GENERATE_EXCEL_CONFIG_LOADER_COMMAND} '--set' 'spin_lock_namespace=atfw::util'")
  set(PROJECT_SERVER_FRAME_CONFIG_GENERATE_EXCEL_CONFIG_LOADER_COMMAND
      "${PROJECT_SERVER_FRAME_CONFIG_GENERATE_EXCEL_CONFIG_LOADER_COMMAND} '--set' 'spin_lock_include_prefix='")
  set(PROJECT_SERVER_FRAME_CONFIG_GENERATE_EXCEL_CONFIG_LOADER_COMMAND
  ...
  list(APPEND PROJECT_SERVER_FRAME_CONFIG_GENERATED_SOURCE_LIST
  ...
  add_custom_command(
    OUTPUT ${PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_HEADER_LIST}
           ${PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_SOURCE_LIST} ${PROJECT_SERVER_FRAME_CONFIG_GENERATED_HEADER_LIST}
    ...
    DEPENDS "${GENERATE_FOR_PB_CLEANUP_SERVER_TARGET_PREBUILD}"
            ...
            "${PROJECT_GENERATED_PBD_DIR}/config.pb"
  ...
  add_custom_target(
    ...
    SOURCES ${PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_HEADER_LIST}
            ${PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_SOURCE_LIST})
  generate_for_pb_register_common_dependency_for_target(config-loader)
  ...
  source_group(
    TREE "${PROJECT_GENERATED_DIR}/${PROJECT_SERVER_FRAME_LIB_LINK}-config"
    FILES "${PROJECT_SERVER_FRAME_CONFIG_GENERATED_HEADER_DIR}/server_frame_build_feature.h"
          "${PROJECT_SERVER_FRAME_CONFIG_GENERATED_SOURCE_DIR}/server_frame_build_feature.cpp")
  ...
  list(LENGTH PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_SOURCE_LIST
       __PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_SOURCE_LIST_LENGTH)
  list(LENGTH PROJECT_SERVER_FRAME_CONFIG_GENERATED_SOURCE_LIST
       __PROJECT_SERVER_FRAME_CONFIG_GENERATED_SOURCE_LIST_LENGTH)
  math(
    EXPR
    __SRC_LIST_LENGTH
    "${__PROJECT_SERVER_FRAME_CONFIG_SOURCE_LIST_LENGTH} + ${__PROJECT_SERVER_FRAME_CONFIG_SET_GENERATED_SOURCE_LIST_LENGTH} + ${__PROJECT_SERVER_FRAME_CONFIG_GENERATED_SOURCE_LIST_LENGTH}"
  )
  if(PROJECT_ENABLE_UNITY_BUILD AND __SRC_LIST_LENGTH GREATER PROJECT_COMPONENT_UNITY_BUILD_MIN_FILE_COUNT)
    set_target_properties("${PROJECT_SERVER_FRAME_LIB_LINK}-config"
