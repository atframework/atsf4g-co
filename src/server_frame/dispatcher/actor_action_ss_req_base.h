...
class actor_action_ss_req_base : public actor_action_req_base<PROJECT_NAMESPACE_ID::SSMsg> {
 public:
  using base_type = actor_action_req_base<PROJECT_NAMESPACE_ID::SSMsg>;
