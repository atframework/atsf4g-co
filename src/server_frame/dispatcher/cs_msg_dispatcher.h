...
#  if defined(SERVER_FRAME_API_NATIVE) && SERVER_FRAME_API_NATIVE
  UTIL_DESIGN_PATTERN_SINGLETON_EXPORT_DECL(cs_msg_dispatcher)
#  else
  UTIL_DESIGN_PATTERN_SINGLETON_IMPORT_DECL(cs_msg_dispatcher)
#  endif
#else
  UTIL_DESIGN_PATTERN_SINGLETON_VISIBLE_DECL(cs_msg_dispatcher)
#endif
