...
namespace detail {
/*
static void load_field_item(util::config::ini_value& parent, const ::google::protobuf::Message& src, const
::google::protobuf::FieldDescriptor* fds) { if (nullptr == fds) { return;
    }
    ...
    switch(fds->cpp_type()) {
        case google::protobuf::FieldDescriptor::CPPTYPE_INT32: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetInt32(src,
fds), doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_INT64: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetInt64(src,
fds), doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_UINT32: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetUInt32(src,
fds), doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_UINT64: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetUInt64(src,
fds), doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_STRING: {
            ...
            if (fds->is_repeated()) {
                ...
                for (int i = 0; i < len; ++ i) {
                    rapidjson::Value v;
                    load_field_string_filter(src.GetReflection()->GetRepeatedStringReference(src, fds, i, &empty), v,
doc, options); rapidsjon_helper_append_to_list(ls, std::move(v), doc);
                }
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), std::move(ls), doc);
            } else {
                rapidjson::Value v;
...
src.GetReflection()->GetRepeatedPtrField<::google::protobuf::Message>(src, fds); if (ls.IsArray()) { for (int i = 0; i <
data.size(); ++ i) { ls.PushBack(rapidjson::kObjectType, doc.GetAllocator()); rapidsjon_helper_load_from(ls[ls.Size() -
1], doc, data.Get(i), options);
                    }
                }
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), std::move(ls), doc);
            } else {
        ...
        case google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetDouble(src,
fds), doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_FLOAT: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetFloat(src,
fds), doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_BOOL: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetBool(src, fds),
doc);
            }
            break;
        };
        case google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
            if (fds->is_repeated()) {
                ...
                rapidsjon_helper_mutable_set_member(parent, fds->name().c_str(), src.GetReflection()->GetEnumValue(src,
fds), doc);
            }
            break;
        };
...
static void dump_pick_field(const util::config::ini_value &val, ::google::protobuf::Message &dst,
                            const ::google::protobuf::FieldDescriptor *fds, size_t index) {
  if (nullptr == fds) {
    return;
  }
  ...
  switch (fds->cpp_type()) {
    ...
    case google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE: {
      ...
      if (fds->message_type()->full_name() == ::google::protobuf::Duration::descriptor()->full_name()) {
        ...
        if (fds->is_repeated()) {
          excel::parse_duration(
              value, *static_cast< ::google::protobuf::Duration *>(dst.GetReflection()->AddMessage(&dst, fds)));
        } else {
          excel::parse_duration(
              value, *static_cast< ::google::protobuf::Duration *>(dst.GetReflection()->MutableMessage(&dst, fds)));
        }
        break;
      } else if (fds->message_type()->full_name() == ::google::protobuf::Timestamp::descriptor()->full_name()) {
        const std::string &value = val.as_cpp_string(index);
        if (fds->is_repeated()) {
          excel::parse_timepoint(
              value, *static_cast< ::google::protobuf::Timestamp *>(dst.GetReflection()->AddMessage(&dst, fds)));
        } else {
          excel::parse_timepoint(
              value, *static_cast< ::google::protobuf::Timestamp *>(dst.GetReflection()->MutableMessage(&dst, fds)));
        }
        break;
      }
    ...
    case google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
      ...
      const google::protobuf::EnumValueDescriptor *jval = nullptr;
...
static void dump_field_item(const util::config::ini_value &src, ::google::protobuf::Message &dst,
