...
GAME_SERVICE_API task_action_matching_event_sync::task_action_matching_event_sync(dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

GAME_SERVICE_API task_action_matching_event_sync::~task_action_matching_event_sync() {}

GAME_SERVICE_API const char* task_action_matching_event_sync::name() const { return "task_action_matching_event_sync"; }

GAME_SERVICE_API task_action_matching_event_sync::result_type task_action_matching_event_sync::operator()() {
...
GAME_SERVICE_API int task_action_matching_event_sync::on_success() { return get_result(); }

GAME_SERVICE_API int task_action_matching_event_sync::on_failed() { return get_result(); }
