...
task_action_object_cache_expired_sync::task_action_object_cache_expired_sync(dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

task_action_object_cache_expired_sync::~task_action_object_cache_expired_sync() {}

const char* task_action_object_cache_expired_sync::name() const { return "task_action_object_cache_expired_sync"; }

task_action_object_cache_expired_sync::result_type task_action_object_cache_expired_sync::operator()() {
