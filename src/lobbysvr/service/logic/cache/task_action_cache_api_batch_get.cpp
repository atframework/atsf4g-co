...
task_action_cache_api_batch_get::task_action_cache_api_batch_get(
    dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

task_action_cache_api_batch_get::~task_action_cache_api_batch_get() {}

const char* task_action_cache_api_batch_get::name() const {
  return "task_action_cache_api_batch_get";
}

task_action_cache_api_batch_get::result_type task_action_cache_api_batch_get::operator()() {
  ...
  auto ret = RPC_AWAIT_CODE_RESULT(user_inst->get_user_cache_manager().pull_cache(
...
int task_action_cache_api_batch_get::on_success() { return get_result(); }

int task_action_cache_api_batch_get::on_failed() { return get_result(); }
