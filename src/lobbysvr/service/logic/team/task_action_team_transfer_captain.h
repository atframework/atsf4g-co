...
class task_action_team_transfer_captain : public task_action_cs_rpc_base<atframework::team::CSTeamTransferCaptainReq,
                                                                         atframework::team::SCTeamTransferCaptainRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::team::CSTeamTransferCaptainReq, atframework::team::SCTeamTransferCaptainRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_transfer_captain(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_transfer_captain() override;
