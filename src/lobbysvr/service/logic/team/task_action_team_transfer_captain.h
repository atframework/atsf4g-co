...
class task_action_team_transfer_captain
    : public task_action_cs_rpc_base<atframework::shared::CSTeamTransferCaptainReq,
                                     atframework::shared::SCTeamTransferCaptainRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::shared::CSTeamTransferCaptainReq,
                                            atframework::shared::SCTeamTransferCaptainRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_transfer_captain(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_transfer_captain() override;
