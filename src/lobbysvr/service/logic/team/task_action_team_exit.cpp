...
ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API const char* task_action_team_exit::name() const {
  return "task_action_team_exit";
}
...
ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API int task_action_team_exit::on_success() { return get_result(); }

ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API int task_action_team_exit::on_failed() { return get_result(); }
