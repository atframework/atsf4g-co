...
class task_action_team_update_team_data : public task_action_cs_rpc_base<atframework::team::CSTeamUpdateTeamDataReq,
                                                                         atframework::team::SCTeamUpdateTeamDataRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::team::CSTeamUpdateTeamDataReq, atframework::team::SCTeamUpdateTeamDataRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_update_team_data(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_update_team_data() override;
