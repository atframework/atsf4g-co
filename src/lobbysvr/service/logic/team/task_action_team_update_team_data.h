...
class task_action_team_update_team_data : public task_action_cs_rpc_base<atframework::shared::CSTeamUpdateTeamDataReq,
                                                                         atframework::shared::SCTeamUpdateTeamDataRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::shared::CSTeamUpdateTeamDataReq,
                                            atframework::shared::SCTeamUpdateTeamDataRsp>;
