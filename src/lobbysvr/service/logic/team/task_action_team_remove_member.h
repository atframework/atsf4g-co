...
class task_action_team_remove_member : public task_action_cs_rpc_base<atframework::team::CSTeamRemoveMemberReq,
                                                                      atframework::team::SCTeamRemoveMemberRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::team::CSTeamRemoveMemberReq, atframework::team::SCTeamRemoveMemberRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_remove_member(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_remove_member() override;
