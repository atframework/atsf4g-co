...
class task_action_team_remove_member : public task_action_cs_rpc_base<atframework::shared::CSTeamRemoveMemberReq,
                                                                      atframework::shared::SCTeamRemoveMemberRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::shared::CSTeamRemoveMemberReq, atframework::shared::SCTeamRemoveMemberRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_remove_member(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_remove_member() override;
