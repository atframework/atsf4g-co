...
class task_action_team_reject_join_request
    : public task_action_cs_rpc_base<atframework::shared::CSTeamRejectJoinRequestReq,
                                     atframework::shared::SCTeamRejectJoinRequestRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::shared::CSTeamRejectJoinRequestReq,
                                            atframework::shared::SCTeamRejectJoinRequestRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_reject_join_request(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_reject_join_request() override;
