...
class task_action_team_set_unready
    : public task_action_cs_rpc_base<atframework::team::CSTeamSetUnreadyReq, atframework::team::SCTeamSetUnreadyRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::team::CSTeamSetUnreadyReq, atframework::team::SCTeamSetUnreadyRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_set_unready(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_set_unready() override;
