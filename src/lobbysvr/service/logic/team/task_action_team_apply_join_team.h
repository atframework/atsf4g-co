...
class task_action_team_apply_join_team : public task_action_cs_rpc_base<atframework::team::CSTeamApplyJoinTeamReq,
                                                                        atframework::team::SCTeamApplyJoinTeamRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::team::CSTeamApplyJoinTeamReq, atframework::team::SCTeamApplyJoinTeamRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_apply_join_team(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_apply_join_team() override;
