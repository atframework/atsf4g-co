...
class task_action_team_send_invitation : public task_action_cs_rpc_base<atframework::shared::CSTeamSendInvitationReq,
                                                                        atframework::shared::SCTeamSendInvitationRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::shared::CSTeamSendInvitationReq,
                                            atframework::shared::SCTeamSendInvitationRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_send_invitation(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_send_invitation() override;
