...
class task_action_team_update_member_data
    : public task_action_cs_rpc_base<atframework::team::CSTeamUpdateMemberDataReq,
                                     atframework::team::SCTeamUpdateMemberDataRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::team::CSTeamUpdateMemberDataReq,
                                            atframework::team::SCTeamUpdateMemberDataRsp>;
