...
class task_action_team_reject_apply : public task_action_cs_rpc_base<atframework::shared::CSTeamRejectApplyReq,
                                                                     atframework::shared::SCTeamRejectApplyRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::shared::CSTeamRejectApplyReq, atframework::shared::SCTeamRejectApplyRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_reject_apply(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_reject_apply() override;
