...
class task_action_team_approve_invitation
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_approve_invitation(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_approve_invitation() override;
