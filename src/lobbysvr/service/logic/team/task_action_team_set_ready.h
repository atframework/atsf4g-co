...
class task_action_team_set_ready
    : public task_action_cs_rpc_base<atframework::team::CSTeamSetReadyReq, atframework::team::SCTeamSetReadyRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::team::CSTeamSetReadyReq, atframework::team::SCTeamSetReadyRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_set_ready(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_set_ready() override;
