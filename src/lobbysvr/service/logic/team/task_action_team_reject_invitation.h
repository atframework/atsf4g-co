...
class task_action_team_reject_invitation
    : public task_action_cs_rpc_base<atframework::team::CSTeamRejectInvitationReq,
                                     atframework::team::SCTeamRejectInvitationRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::team::CSTeamRejectInvitationReq,
                                            atframework::team::SCTeamRejectInvitationRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_reject_invitation(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_reject_invitation() override;
