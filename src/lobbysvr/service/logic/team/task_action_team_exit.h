...
class task_action_team_exit
    : public task_action_cs_rpc_base<atframework::team::CSTeamExitReq, atframework::team::SCTeamExitRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::team::CSTeamExitReq, atframework::team::SCTeamExitRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_exit(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_exit() override;
