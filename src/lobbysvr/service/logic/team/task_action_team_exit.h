...
class task_action_team_exit
    : public task_action_cs_rpc_base<atframework::shared::CSTeamExitReq, atframework::shared::SCTeamExitRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::shared::CSTeamExitReq, atframework::shared::SCTeamExitRsp>;
 ...
 public:
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API explicit task_action_team_exit(dispatcher_start_data_type&& param);
  ATFRAMEWORK_SHARED_LOBBYSVRCLIENTSERVICE_API ~task_action_team_exit() override;
