...
class task_action_team_accept_apply
    : public task_action_cs_rpc_base<atframework::team::CSTeamAcceptApplyReq, atframework::team::SCTeamAcceptApplyRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::team::CSTeamAcceptApplyReq, atframework::team::SCTeamAcceptApplyRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_team_accept_apply(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_team_accept_apply() override;
