#include "task_action_rank_get_self_rank.h"
...
task_action_rank_get_self_rank::~task_action_rank_get_self_rank() {}

const char* task_action_rank_get_self_rank::name() const { return "task_action_rank_get_self_rank"; }

task_action_rank_get_self_rank::result_type task_action_rank_get_self_rank::operator()() {
  ...
  if (req_body.rank_key().rank_type() == PROJECT_NAMESPACE_ID::EN_RANK_LOGIC_TYPE_INVALID ||
      req_body.up_count() + req_body.down_count() + 1 > rank_util::RANK_GET_TOP_MAX_COUNT) {
...
int task_action_rank_get_self_rank::on_success() { return get_result(); }

int task_action_rank_get_self_rank::on_failed() { return get_result(); }
