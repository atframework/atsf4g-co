...
class task_action_chat_get_channel_snapshot
    : public task_action_cs_rpc_base<atframework::chat::CSChatGetChannelSnapshotReq,
                                     atframework::chat::SCChatGetChannelSnapshotRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::chat::CSChatGetChannelSnapshotReq,
                                            atframework::chat::SCChatGetChannelSnapshotRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_chat_get_channel_snapshot(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_chat_get_channel_snapshot() override;
