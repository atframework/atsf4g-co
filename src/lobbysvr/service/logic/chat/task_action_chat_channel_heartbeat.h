...
class task_action_chat_channel_heartbeat
    : public task_action_cs_rpc_base<atframework::chat::CSChatChannelHeartbeatReq,
                                     atframework::chat::SCChatChannelHeartbeatRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::chat::CSChatChannelHeartbeatReq,
                                            atframework::chat::SCChatChannelHeartbeatRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_chat_channel_heartbeat(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_chat_channel_heartbeat() override;
