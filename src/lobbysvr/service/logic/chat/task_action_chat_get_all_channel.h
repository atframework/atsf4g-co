...
class task_action_chat_get_all_channel : public task_action_cs_rpc_base<atframework::chat::CSChatGetAllChannelReq,
                                                                        atframework::chat::SCChatGetAllChannelRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::chat::CSChatGetAllChannelReq, atframework::chat::SCChatGetAllChannelRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_chat_get_all_channel(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_chat_get_all_channel() override;
