...
class task_action_chat_channel_unsubscribe
    : public task_action_cs_rpc_base<atframework::chat::CSChatChannelUnsubscribeReq,
                                     atframework::chat::SCChatChannelUnsubscribeRsp> {
 public:
  using base_type = task_action_cs_rpc_base<atframework::chat::CSChatChannelUnsubscribeReq,
                                            atframework::chat::SCChatChannelUnsubscribeRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_chat_channel_unsubscribe(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_chat_channel_unsubscribe() override;
