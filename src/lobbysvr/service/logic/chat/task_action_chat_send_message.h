...
class task_action_chat_send_message
    : public task_action_cs_rpc_base<atframework::chat::CSChatSendMessageReq, atframework::chat::SCChatSendMessageRsp> {
 public:
  using base_type =
      task_action_cs_rpc_base<atframework::chat::CSChatSendMessageReq, atframework::chat::SCChatSendMessageRsp>;
 ...
 public:
  GAMECLIENT_SERVICE_API explicit task_action_chat_send_message(dispatcher_start_data_type&& param);
  GAMECLIENT_SERVICE_API ~task_action_chat_send_message() override;
