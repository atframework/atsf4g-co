...
class task_action_login : public task_action_cs_rpc_base<hello::CSLoginReq, hello::SCLoginRsp> {
 public:
  using base_type = task_action_cs_rpc_base<hello::CSLoginReq, hello::SCLoginRsp>;
