...
class task_action_access_update : public task_action_cs_rpc_base<hello::CSAccessUpdateReq, hello::SCAccessUpdateRsp> {
 public:
  using base_type = task_action_cs_rpc_base<hello::CSAccessUpdateReq, hello::SCAccessUpdateRsp>;
