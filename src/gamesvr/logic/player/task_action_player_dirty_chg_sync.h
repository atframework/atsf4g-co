...
class task_action_player_dirty_chg_sync : public task_action_cs_rpc_base<google::protobuf::Empty, hello::SCPlayerDirtyChgSync> {
 public:
  using base_type = task_action_cs_rpc_base<google::protobuf::Empty, hello::SCPlayerDirtyChgSync>;
