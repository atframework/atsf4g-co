...
generate_for_pb_add_service("hello.RouterService" "${CMAKE_CURRENT_LIST_DIR}/server_frame"
    TASK_PATH_PREFIX "router"
    HANDLE_PATH_PREFIX "router"
    PROJECT_NAMESPACE "hello"
)

# add tool to binding gamesvr rpcs
generate_for_pb_add_service("hello.GamesvrService" "${CMAKE_CURRENT_LIST_DIR}/gamesvr"
