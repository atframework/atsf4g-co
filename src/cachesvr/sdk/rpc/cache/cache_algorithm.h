...
CACHE_RPC_API void update_cache_meta_from_origin_data(
    ::rpc::context& ctx, PROJECT_NAMESPACE_ID::DUserBasicDataMeta& output, uint64_t user_id, uint32_t zone_id,
    uint64_t data_version, const PROJECT_NAMESPACE_ID::user_login_data* input_login_data,
