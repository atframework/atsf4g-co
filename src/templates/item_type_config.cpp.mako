...
<%
                  item_type_option = enum_value.get_extension('atframework.shard.item_type_option')
...
<%
                item_type_option = enum_value.get_extension('atframework.shard.item_type_option')
                item_excel_option = enum_value.get_extension('atframework.shard.item_excel_option')
                if item_type_option == None:
                      continue
