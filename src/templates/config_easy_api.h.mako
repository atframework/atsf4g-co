...
EXCEL_CONFIG_LOADER_API const std::string& get_config_group_version(const excel_config_type_traits::shared_ptr<config_group_t>&) noexcept;
...
EXCEL_CONFIG_LOADER_API std::size_t get_${loader.code.class_name}_version(const excel_config_type_traits::shared_ptr<config_group_t>&);
