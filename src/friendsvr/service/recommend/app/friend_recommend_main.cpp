...
class main_service_module : public atfw::atapp::module_impl {
 public:
  int init() override {
    ...
    // register handles
    INIT_CALL_FN(handle::friends::register_handles_for_friendrecommendservice);
    return 0;
  };
...
int main(int argc, char *argv[]) {
  ...
  logic_config::me()->set_server_instance_config_loader(
      [](atfw::atapp::app &app_, logic_config & /*cfg*/, logic_config::server_instance_config_ptr &to) {
        auto config_ptr =
            atfw::component::memory::stl::make_strong_rc<atframework::friends::config::friendsvr_recommend_cfg>();
