...
class task_action_management_gm_reset_limit
    : public task_action_ss_rpc_base<atframework::friend_api::SSFriendGMResetLimitReq,
                                     atframework::friend_api::SSFriendGMResetLimitRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendGMResetLimitReq,
                                            atframework::friend_api::SSFriendGMResetLimitRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_gm_reset_limit(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_gm_reset_limit() override;
