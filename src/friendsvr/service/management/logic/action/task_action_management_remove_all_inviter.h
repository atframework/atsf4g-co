...
class task_action_management_remove_all_inviter
    : public task_action_ss_rpc_base<atframework::friend_api::SSFriendRemoveAllInviterReq,
                                     atframework::friend_api::SSFriendRemoveAllInviterRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendRemoveAllInviterReq,
                                            atframework::friend_api::SSFriendRemoveAllInviterRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_remove_all_inviter(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_remove_all_inviter() override;
