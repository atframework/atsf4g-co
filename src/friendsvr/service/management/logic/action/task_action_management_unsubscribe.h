...
class task_action_management_unsubscribe
    : public task_action_ss_rpc_base<atframework::friend_api::SSFriendUnsubscribeReq,
                                     atframework::friend_api::SSFriendUnsubscribeRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendUnsubscribeReq,
                                            atframework::friend_api::SSFriendUnsubscribeRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_unsubscribe(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_unsubscribe() override;
