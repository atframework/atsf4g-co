...
#include "logic/action/task_action_management_remove_one_inviter.h"
...
task_action_management_remove_one_inviter::task_action_management_remove_one_inviter(dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API
task_action_management_remove_one_inviter::~task_action_management_remove_one_inviter() {}

ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API const char* task_action_management_remove_one_inviter::name() const {
  return "task_action_management_remove_one_inviter";
}

ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API task_action_management_remove_one_inviter::result_type
task_action_management_remove_one_inviter::operator()() {
  ...
  protobuf_copy_message(*event_log.mutable_remove_inviter()->mutable_from_user(), req_body.inviter_user_key());
  auto wal_log = friend_obj->get_wal_publisher().allocate_log(
      get_shared_context().logical_now(), atfw::friend_api::DFriendEvent::kRemoveInviter, param, std::move(event_log));
  if (!wal_log) {
...
ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API int task_action_management_remove_one_inviter::on_success() {
  return get_result();
}

ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API int task_action_management_remove_one_inviter::on_failed() {
  return get_result();
}
