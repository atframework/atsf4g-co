...
class task_action_management_transaction_prepare
    : public task_action_ss_rpc_base<atframework::friend_api::SSFriendTransactionPrepareReq,
                                     atframework::friend_api::SSFriendTransactionPrepareRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendTransactionPrepareReq,
                                            atframework::friend_api::SSFriendTransactionPrepareRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_transaction_prepare(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_transaction_prepare() override;
