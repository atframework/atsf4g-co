...
class task_action_management_transaction_reject
    : public task_action_ss_rpc_base<atframework::friend_api::SSFriendTransactionRejectReq,
                                     atframework::friend_api::SSFriendTransactionRejectRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendTransactionRejectReq,
                                            atframework::friend_api::SSFriendTransactionRejectRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_transaction_reject(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_transaction_reject() override;
