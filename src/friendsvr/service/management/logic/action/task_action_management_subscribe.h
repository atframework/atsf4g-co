...
class task_action_management_subscribe : public task_action_ss_rpc_base<atframework::friend_api::SSFriendSubscribeReq,
                                                                        atframework::friend_api::SSFriendSubscribeRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendSubscribeReq,
                                            atframework::friend_api::SSFriendSubscribeRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_subscribe(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_subscribe() override;
