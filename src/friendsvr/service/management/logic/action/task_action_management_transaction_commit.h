...
class task_action_management_transaction_commit
    : public task_action_ss_rpc_base<atframework::friend_api::SSFriendTransactionCommitReq,
                                     atframework::friend_api::SSFriendTransactionCommitRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::friend_api::SSFriendTransactionCommitReq,
                                            atframework::friend_api::SSFriendTransactionCommitRsp>;
 ...
 public:
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API explicit task_action_management_transaction_commit(
      dispatcher_start_data_type&& param);
  ATFRAMEWORK_FRIEND_API_FRIENDMANAGEMENTSERVICE_API ~task_action_management_transaction_commit() override;
