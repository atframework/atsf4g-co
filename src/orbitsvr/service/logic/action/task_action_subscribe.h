...
class task_action_subscribe : public task_action_ss_rpc_base<PROJECT_NAMESPACE_ID::SSOrbitSubscribeRoomReq,
                                                             PROJECT_NAMESPACE_ID::SSOrbitSubscribeRoomRsp> {
 public:
  using base_type = task_action_ss_rpc_base<PROJECT_NAMESPACE_ID::SSOrbitSubscribeRoomReq,
                                            PROJECT_NAMESPACE_ID::SSOrbitSubscribeRoomRsp>;
 ...
 public:
  GAME_SERVICE_API explicit task_action_subscribe(dispatcher_start_data_type&& param);
  GAME_SERVICE_API ~task_action_subscribe() override;
