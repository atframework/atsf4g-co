...
GAME_SERVICE_API task_action_create_room::task_action_create_room(dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

GAME_SERVICE_API task_action_create_room::~task_action_create_room() {}

GAME_SERVICE_API const char* task_action_create_room::name() const { return "task_action_create_room"; }

GAME_SERVICE_API task_action_create_room::result_type task_action_create_room::operator()() {
...
GAME_SERVICE_API int task_action_create_room::on_failed() { return get_result(); }
