...
task_action_user_finish::task_action_user_finish(dispatcher_start_data_type &&param)
    : base_type(std::move(param)) {}

task_action_user_finish::~task_action_user_finish() {}

const char *task_action_user_finish::name() const { return "task_action_user_finish"; }

task_action_user_finish::result_type task_action_user_finish::operator()() {
...
int task_action_user_finish::on_success() { return get_result(); }

int task_action_user_finish::on_failed() { return get_result(); }
