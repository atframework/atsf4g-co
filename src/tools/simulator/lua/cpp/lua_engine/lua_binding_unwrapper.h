...
struct unwraper_var_lua_type {
  ...
  static Tt unwraper(lua_State *L, int index) {
    using obj_t =
        typename std::remove_cv<typename std::remove_reference<typename std::remove_pointer<Tt>::type>::type>::type;
    ...
    if (lua_gettop(L) < index) {
      return static_cast<Tt>(0);  // nullptr static_cast from 'null_ptr' to 'unsigned long' is not allowed
    }
    if (lua_isnil(L, index)) {
      return static_cast<Tt>(0);  // nullptr static_cast from 'null_ptr' to 'unsigned long' is not allowed
    }
...
struct unwraper_static_fn<Tr, lua_State *, TParam...> : public unwraper_static_fn_base_with_L<Tr> {
  using base_type = unwraper_static_fn_base_with_L<Tr>;
  using value_type = Tr (*)(lua_State *, TParam...);
...
struct unwraper_static_fn : public unwraper_static_fn_base<Tr> {
  using base_type = unwraper_static_fn_base<Tr>;
  using value_type = Tr (*)(TParam...);
...
struct unwraper_functor_fn<Tr, lua_State *, TParam...> : public unwraper_static_fn_base_with_L<Tr> {
  using base_type = unwraper_static_fn_base_with_L<Tr>;
  using value_type = std::function<Tr(lua_State *, TParam...)>;
...
struct unwraper_functor_fn : public unwraper_static_fn_base<Tr> {
  using base_type = unwraper_static_fn_base<Tr>;
  using value_type = std::function<Tr(TParam...)>;
