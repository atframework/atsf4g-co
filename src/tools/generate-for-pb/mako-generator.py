...
DEFAULT_GENERATOR_SERVER_ADDRESS = "127.0.0.1:3701"
...
def _get_pb2_module():
    global LOCAL_PB2_MODULE
    current_pb2_module = sys.modules.get("google.protobuf.descriptor_pb2")
    if (LOCAL_PB2_MODULE is not None and current_pb2_module is not None
            and LOCAL_PB2_MODULE is not current_pb2_module):
        _reset_pb2_module_cache()
