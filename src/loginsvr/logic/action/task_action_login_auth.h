...
class task_action_login_auth : public task_action_cs_rpc_base<hello::CSLoginAuthReq, hello::SCLoginAuthRsp> {
 public:
  using base_type = task_action_cs_rpc_base<hello::CSLoginAuthReq, hello::SCLoginAuthRsp>;
