...
class task_action_approve_invitation
    : public task_action_ss_rpc_base<atframework::team::SSTeamRoomApproveInvitationReq,
                                     atframework::team::SSTeamRoomApproveInvitationRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::team::SSTeamRoomApproveInvitationReq,
                                            atframework::team::SSTeamRoomApproveInvitationRsp>;
 ...
 public:
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API explicit task_action_approve_invitation(dispatcher_start_data_type&& param);
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API ~task_action_approve_invitation() override;
