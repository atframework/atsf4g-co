...
class task_action_create
    : public task_action_ss_rpc_base<atframework::team::SSTeamRoomCreateReq, atframework::team::SSTeamRoomCreateRsp> {
 public:
  using base_type =
      task_action_ss_rpc_base<atframework::team::SSTeamRoomCreateReq, atframework::team::SSTeamRoomCreateRsp>;
 ...
 public:
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API explicit task_action_create(dispatcher_start_data_type&& param);
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API ~task_action_create() override;
