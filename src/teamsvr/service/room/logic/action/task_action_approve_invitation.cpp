...
#include "logic/action/task_action_approve_invitation.h"
...
ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API task_action_approve_invitation::task_action_approve_invitation(
    dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API task_action_approve_invitation::~task_action_approve_invitation() {}

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API const char* task_action_approve_invitation::name() const {
  return "task_action_approve_invitation";
}

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API task_action_approve_invitation::result_type
task_action_approve_invitation::operator()() {
...
ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API int task_action_approve_invitation::on_success() { return get_result(); }

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API int task_action_approve_invitation::on_failed() { return get_result(); }
