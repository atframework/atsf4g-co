...
#include "logic/action/task_action_approve_join_request.h"
...
ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API task_action_approve_join_request::task_action_approve_join_request(
    dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API task_action_approve_join_request::~task_action_approve_join_request() {}

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API const char* task_action_approve_join_request::name() const {
  return "task_action_approve_join_request";
}

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API task_action_approve_join_request::result_type
task_action_approve_join_request::operator()() {
  ...
  uint64_t dest_server_id = rpc::team::team_api::get_teamsvr_room_server_id_of_zone(req_body.applicant().zone_id(),
...
ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API int task_action_approve_join_request::on_success() { return get_result(); }

ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API int task_action_approve_join_request::on_failed() { return get_result(); }
