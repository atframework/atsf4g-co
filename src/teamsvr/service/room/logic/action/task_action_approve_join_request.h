...
class task_action_approve_join_request
    : public task_action_ss_rpc_base<atframework::team::SSTeamRoomApproveJoinRequestReq,
                                     atframework::team::SSTeamRoomApproveJoinRequestRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::team::SSTeamRoomApproveJoinRequestReq,
                                            atframework::team::SSTeamRoomApproveJoinRequestRsp>;
 ...
 public:
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API explicit task_action_approve_join_request(dispatcher_start_data_type&& param);
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API ~task_action_approve_join_request() override;
