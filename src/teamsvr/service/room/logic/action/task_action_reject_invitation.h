...
class task_action_reject_invitation : public task_action_ss_rpc_base<atframework::team::SSTeamRoomRejectInvitationReq,
                                                                     atframework::team::SSTeamRoomRejectInvitationRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atframework::team::SSTeamRoomRejectInvitationReq,
                                            atframework::team::SSTeamRoomRejectInvitationRsp>;
 ...
 public:
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API explicit task_action_reject_invitation(dispatcher_start_data_type&& param);
  ATFRAMEWORK_TEAM_TEAMROOMSERVICE_API ~task_action_reject_invitation() override;
