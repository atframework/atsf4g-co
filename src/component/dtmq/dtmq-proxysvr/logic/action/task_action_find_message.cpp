...
task_action_find_message::task_action_find_message(dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

task_action_find_message::~task_action_find_message() {}

const char* task_action_find_message::name() const { return "task_action_find_message"; }

task_action_find_message::result_type task_action_find_message::operator()() {
...
int task_action_find_message::on_success() { return get_result(); }

int task_action_find_message::on_failed() { return get_result(); }
