...
task_action_page_query_message::task_action_page_query_message(
    dispatcher_start_data_type&& param)
    : base_type(std::move(param)) {}

task_action_page_query_message::~task_action_page_query_message() {}

const char* task_action_page_query_message::name() const {
  return "task_action_page_query_message";
}

task_action_page_query_message::result_type task_action_page_query_message::operator()() {
...
int task_action_page_query_message::on_success() { return get_result(); }

int task_action_page_query_message::on_failed() { return get_result(); }
