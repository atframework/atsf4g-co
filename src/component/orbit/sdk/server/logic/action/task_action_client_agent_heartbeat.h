...
class task_action_client_agent_heartbeat
    : public task_action_ss_rpc_base<atfw::orbit::CTSClientAgentHeartbeatNotify, google::protobuf::Empty> {
 public:
  using base_type = task_action_ss_rpc_base<atfw::orbit::CTSClientAgentHeartbeatNotify, google::protobuf::Empty>;
