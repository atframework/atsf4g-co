...
class task_action_forward_to_server
    : public task_action_ss_rpc_base<orbit::CTSForwardToServerNotify, google::protobuf::Empty> {
 public:
  using base_type = task_action_ss_rpc_base<orbit::CTSForwardToServerNotify, google::protobuf::Empty>;
