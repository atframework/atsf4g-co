...
#ifndef GENERATED_HANDLE_ORBIT_RPC_${service.get_identify_upper_rule(output_render_path)}
#define GENERATED_HANDLE_ORBIT_RPC_${service.get_identify_upper_rule(output_render_path)}
