...
#include "logic/action/task_action_start_client.h"
...
task_action_start_client::task_action_start_client(dispatcher_start_data_type&& param) : base_type(std::move(param)) {}
