...
class task_action_client_heartbeat
    : public task_action_ss_rpc_base<orbit::STAClientHeartbeatNotify, google::protobuf::Empty> {
 public:
  using base_type = task_action_ss_rpc_base<orbit::STAClientHeartbeatNotify, google::protobuf::Empty>;
