...
class task_action_client_heartbeat
    : public task_action_ss_rpc_base<atfw::orbit::DTAClientHeartbeatReq, atfw::orbit::ATDClientHeartbeatRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atfw::orbit::DTAClientHeartbeatReq, atfw::orbit::ATDClientHeartbeatRsp>;
