...
#include "logic/action/task_action_client_exit.h"
...
task_action_client_exit::task_action_client_exit(dispatcher_start_data_type&& param) : base_type(std::move(param)) {}
