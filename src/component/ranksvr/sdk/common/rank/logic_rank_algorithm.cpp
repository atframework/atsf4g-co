...
RANK_SDK_API uint32_t logic_rank_elo_get_ea(uint32_t ra, uint32_t rb, uint32_t k, uint32_t rating_point) {
  if (rating_point <= 0) {
    rating_point = 400;
  }
...
RANK_SDK_API uint32_t logic_rank_elo_get_winner_score(uint32_t winner_score, uint32_t loser_socre, uint32_t k,
...
RANK_SDK_API uint32_t logic_rank_elo_get_loser_score(uint32_t winner_score, uint32_t loser_socre, uint32_t k,
                                                     uint32_t rating_point) {
