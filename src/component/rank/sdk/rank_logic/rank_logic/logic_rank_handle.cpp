...
RANK_LOGIC_SDK_API bool logic_rank_handle_self_impl::is_current(const PROJECT_NAMESPACE_ID::config::ExcelRankRule& /*cfg*/,
                                                          time_t /*now*/,
...
RANK_LOGIC_SDK_API logic_rank_handle_variant& logic_rank_handle_variant::operator=(const logic_rank_handle_variant& other) {
  destructor_delegate();
  variant_type_ = other.variant_type_;
  enable_image_ = other.enable_image_;
...
RANK_LOGIC_SDK_API uint32_t logic_rank_handle_variant::get_world_id() const noexcept { return delegate_->get_world_id(); }
