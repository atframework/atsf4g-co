 ...
 * @return future of 0 or error code
 */
ATFW_EXPLICIT_NODISCARD_ATTR RANK_BOARD_SDK_API rpc::result_code_type make_new_mirror(
    rpc::context& ctx, const PROJECT_NAMESPACE_ID::DRankKey& rank, int64_t& mirror_id);
};  // namespace rank_board
};  // namespace rpc
