...
class task_action_rank_get_special : public task_action_ss_rpc_base<atfw::rank::SSRankGetSpecifyRankReq,
                                                                    atfw::rank::SSRankGetSpecifyRankRsp> {
 public:
  using base_type = task_action_ss_rpc_base<atfw::rank::SSRankGetSpecifyRankReq,
                                            atfw::rank::SSRankGetSpecifyRankRsp>;
