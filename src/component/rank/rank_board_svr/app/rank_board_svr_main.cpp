...
class main_service_module : public atapp::module_impl {
 public:
  ...
  int init() override {
    ...
    INIT_CALL_FN(handle::rank_board::register_handles_for_rankboardservice);
...
int main(int argc, char *argv[]) {
  ...
  logic_config::me()->set_server_instance_config_loader(
      [](atfw::atapp::app &app_, logic_config & /*cfg*/, logic_config::server_instance_config_ptr &to_) {
        auto config_ptr = atfw::component::memory::stl::make_strong_rc<atframework::rank::config::ranksvr_cfg>();
