...
#include "task_action_commit_participator.h"
...
const char* task_action_commit_participator::name() const { return "task_action_commit_participator"; }

task_action_commit_participator::result_type task_action_commit_participator::operator()() {
...
int task_action_commit_participator::on_failed() { return get_result(); }
