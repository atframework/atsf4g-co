...
file(APPEND ${GENERATE_FOR_PB_OUT_SH} "\"${GENERATE_FOR_PB_PROROC_BIN}\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
...
file(APPEND ${GENERATE_FOR_PB_OUT_PWSH} "& \"${GENERATE_FOR_PB_PROROC_BIN}\" `${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
foreach(PROTO_PATH IN LISTS GENERATE_FOR_PB_PROTO_PATH)
