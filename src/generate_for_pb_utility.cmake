...
file(
  ...
  "\"${GENERATE_FOR_PB_PROROC_BIN}\" --proto_path \"${PROJECT_THIRD_PARTY_XRESCODE_GENERATOR_REPO_DIR}/pb_extension\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
  ...
  "  \"${PROJECT_THIRD_PARTY_XRESCODE_GENERATOR_REPO_DIR}/pb_extension/xrescode_extensions_v3.proto\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
...
file(GLOB_RECURSE GENERATE_FOR_PB_PY_PROTO_FILES "${PROJECT_SERVER_FRAME_BAS_DIR}/protocol/config/*.proto"
     "${PROJECT_SERVER_FRAME_BAS_DIR}/protocol/pbdesc/*.proto" "${ATFRAMEWORK_ATBUS_INC_DIR}/*.proto"
...
execute_process(
  COMMAND
    ...
    "${PROJECT_SERVER_FRAME_BAS_DIR}/protocol/pbdesc" "--proto_path" "${PROJECT_THIRD_PARTY_INSTALL_DIR}/include" "--proto_path"
    ${ATFRAMEWORK_ATBUS_INC_DIR} "--proto_path" ${ATFRAMEWORK_ATAPP_INC_DIR} "-o"
