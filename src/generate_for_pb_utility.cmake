...
execute_process(
  COMMAND
    ${GENERATE_FOR_PB_PROROC_BIN} ${GENERATE_FOR_PB_PY_PROTO_PATH_ARGS} "-o" "${PROJECT_INSTALL_RES_PBD_DIR}/network.pb"
  ...
  WORKING_DIRECTORY "${GENERATE_FOR_PB_WORK_DIR}" COMMAND_ECHO STDOUT ${GENERATE_FOR_PB_PY_ENCODING})
...
function(generate_for_pb_add_ss_service SERVICE_NAME SERVICE_ROOT_DIR)
  ...
  unset(GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_BASH_ARGS)
  unset(GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_CMAKE_ARGS)
  if(GENERATE_FOR_PB_ARGS_RPC_IGNORE_EMPTY_REQUEST)
    set(GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_BASH_ARGS "${GENERATE_FOR_PB_ARGS_BASH_ARGS} --rpc-ignore-empty-request")
    list(APPEND GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_CMAKE_ARGS "--rpc-ignore-empty-request")
  endif()
  ...
  file(
    ...
    "  --set project_namespace=${GENERATE_FOR_PB_ARGS_PROJECT_NAMESPACE} --set rpc_include_prefix=${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --add-path \"${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  ${GENERATE_FOR_PB_ARGS_BASH_ARGS} ${GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_BASH_ARGS} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
  ...
  file(APPEND "${GENERATE_FOR_PB_OUT_LOG}"
       "-- Ready to run ${Python3_EXECUTABLE} ${GENERATE_FOR_PB_PY} for ${SERVICE_NAME} @ ${SERVICE_ROOT_DIR}\n")
  execute_process(
    COMMAND
    ...
    COMMAND
      ...
      "rpc_include_prefix=${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}" "--add-path"
      "${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules" ${GENERATE_FOR_PB_ARGS_CMAKE_ARGS} ${GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_CMAKE_ARGS} "--rpc-template"
...
function(generate_for_pb_add_cs_service SERVICE_NAME SERVICE_ROOT_DIR)
  ...
  file(
    ...
    "  --add-path \"${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  ${GENERATE_FOR_PB_ARGS_BASH_ARGS} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --service-template 'templates/session_downstream_api_for_cs.h.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.h' \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --service-template 'templates/session_downstream_api_for_cs.cpp.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.cpp' ${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
  )
  ...
  file(
    ...
    "  --add-path \"${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  ${GENERATE_FOR_PB_ARGS_BASH_ARGS} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --service-template 'templates/handle_cs_rpc.h.mako:${HANDLE_PATH_PREFIX}handle_cs_rpc_\${service.get_name_lower_rule()}.h' \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --service-template 'templates/handle_cs_rpc.cpp.mako:${HANDLE_PATH_PREFIX}handle_cs_rpc_\${service.get_name_lower_rule()}.cpp' ${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
  )
  ...
  file(
    ...
    "  --add-path \"${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  ${GENERATE_FOR_PB_ARGS_BASH_ARGS} ${GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_BASH_ARGS} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --rpc-template 'templates/task_action_cs_rpc.h.mako:${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}/\${rpc.get_extension_field(\"rpc_options\", lambda x: x.module_name, \"action\")}/task_action_\${rpc.get_name()}.h' \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --rpc-template 'templates/task_action_cs_rpc.cpp.mako:${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}/\${rpc.get_extension_field(\"rpc_options\", lambda x: x.module_name, \"action\")}/task_action_\${rpc.get_name()}.cpp' ${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
  )
  ...
  execute_process(
    COMMAND
      ...
      "rpc_include_prefix=${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}" "--add-path"
      "${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules" ${GENERATE_FOR_PB_ARGS_CMAKE_ARGS} "--service-template"
      "templates/session_downstream_api_for_cs.h.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.h"
      "--service-template"
    ...
    COMMAND
      ...
      "rpc_include_prefix=${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}" "--add-path"
      "${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules" ${GENERATE_FOR_PB_ARGS_CMAKE_ARGS} "--service-template"
      "templates/handle_cs_rpc.h.mako:${HANDLE_PATH_PREFIX}handle_cs_rpc_\${service.get_name_lower_rule()}.h"
      "--service-template"
    ...
    COMMAND
      ...
      "rpc_include_prefix=${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}" "--add-path"
      "${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules" ${GENERATE_FOR_PB_ARGS_CMAKE_ARGS} ${GENERATE_FOR_PB_RPC_TEMPLATE_ARGS_CMAKE_ARGS} "--rpc-template"
      "templates/task_action_cs_rpc.h.mako:${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}/\${rpc.get_extension_field(\"rpc_options\", lambda x: x.module_name, \"action\")}/task_action_\${rpc.get_name()}.h"
      "--rpc-template"
      "templates/task_action_cs_rpc.cpp.mako:${GENERATE_FOR_PB_ARGS_TASK_PATH_PREFIX}/\${rpc.get_extension_field(\"rpc_options\", lambda x: x.module_name, \"action\")}/task_action_\${rpc.get_name()}.cpp"
    WORKING_DIRECTORY "${GENERATE_FOR_PB_WORK_DIR}"
    OUTPUT_FILE "${GENERATE_FOR_PB_OUT_LOG}"
    ERROR_FILE "${GENERATE_FOR_PB_OUT_LOG}" COMMAND_ECHO STDOUT ${GENERATE_FOR_PB_PY_ENCODING})
...
function(generate_for_pb_add_simulator_cs_api SERVICE_NAME SERVICE_ROOT_DIR)
  set(GENERATE_FOR_PB_ARGS_OPTIONS RPC_IGNORE_EMPTY_REQUEST)
  set(GENERATE_FOR_PB_ARGS_ONE_VALUE PROJECT_NAMESPACE PROTOBUF_PYTHON_PATH
                                     MAKO_PYTHON_PATH SIX_PYTHON_PATH)
  set(GENERATE_FOR_PB_ARGS_MULTI_VALUE "")
  cmake_parse_arguments(PARSE_ARGV 2 GENERATE_FOR_PB_ARGS "${GENERATE_FOR_PB_ARGS_OPTIONS}"
                        "${GENERATE_FOR_PB_ARGS_ONE_VALUE}" "${GENERATE_FOR_PB_ARGS_MULTI_VALUE}")
  ...
  file(
    ...
    "\"${Python3_EXECUTABLE}\" \"${GENERATE_FOR_PB_PY}\" -s ${SERVICE_NAME} -o \"${SERVICE_ROOT_DIR}\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --project-dir \"${PROJECT_SOURCE_DIR}\" --pb-file \"${PROJECT_INSTALL_RES_PBD_DIR}/network.pb\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --set project_namespace=${GENERATE_FOR_PB_ARGS_PROJECT_NAMESPACE} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --add-path \"${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules\" \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  ${GENERATE_FOR_PB_ARGS_BASH_ARGS} \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --service-template 'templates/package_request_api_for_simulator.h.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.h' \\${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
    "  --service-template 'templates/package_request_api_for_simulator.cpp.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.cpp' ${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
  )
  ...
  execute_process(
    COMMAND
      ${Python3_EXECUTABLE} ${GENERATE_FOR_PB_PY} "--quiet" "-s" "${SERVICE_NAME}" "-o" "${SERVICE_ROOT_DIR}"
      "--project-dir" ${PROJECT_SOURCE_DIR} "--pb-file" "${PROJECT_INSTALL_RES_PBD_DIR}/network.pb" "--set"
      "project_namespace=${GENERATE_FOR_PB_ARGS_PROJECT_NAMESPACE}" "--add-path"
      "${ATFRAMEWORK_CMAKE_TOOLSET_DIR}/modules" ${GENERATE_FOR_PB_ARGS_CMAKE_ARGS}
      "--service-template" "templates/package_request_api_for_simulator.h.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.h"
      "--service-template" "templates/package_request_api_for_simulator.cpp.mako:rpc/\${service.get_extension_field(\"service_options\", lambda x: x.module_name, service.get_name_lower_rule())}/\${service.get_name_lower_rule()}.cpp"
    WORKING_DIRECTORY "${GENERATE_FOR_PB_WORK_DIR}"
    OUTPUT_FILE "${GENERATE_FOR_PB_OUT_LOG}"
    ERROR_FILE "${GENERATE_FOR_PB_OUT_LOG}" COMMAND_ECHO STDOUT ${GENERATE_FOR_PB_PY_ENCODING})
