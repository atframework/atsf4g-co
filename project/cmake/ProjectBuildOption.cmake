...
if(MSVC)
  set(PROJECT_MSVC_INCREMENTAL_LINK_DATABASE_DIRECTORY
      "${CMAKE_BINARY_DIR}/_ilk"
      CACHE PATH "Directory for MSVC incremental link database files.")
  file(MAKE_DIRECTORY "${PROJECT_MSVC_INCREMENTAL_LINK_DATABASE_DIRECTORY}")
endif()
set(PROJECT_MULTI_CONFIG_OUTPUT_TYPES Debug Release RelWithDebInfo MinSizeRel)
if(CMAKE_CONFIGURATION_TYPES)
  set(PROJECT_MULTI_CONFIG_OUTPUT_TYPES ${CMAKE_CONFIGURATION_TYPES})
endif()
...
project_set_output_directory_per_config(CMAKE_ARCHIVE_OUTPUT_DIRECTORY)
project_set_output_directory_per_config(CMAKE_LIBRARY_OUTPUT_DIRECTORY)
project_set_output_directory_per_config(CMAKE_RUNTIME_OUTPUT_DIRECTORY)

if(MSVC)
  set(CMAKE_PDB_OUTPUT_DIRECTORY "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}")
  project_set_output_directory_per_config(CMAKE_PDB_OUTPUT_DIRECTORY)
endif()
...
if(MSVC)
  ...
  string(APPEND CMAKE_MODULE_LINKER_FLAGS " /IGNORE:4099")
endif()
