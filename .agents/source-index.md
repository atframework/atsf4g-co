...
| Lobby team integration and notifications | `../src/lobbysvr/service/logic/team/`, `../src/teamsvr/service/room/logic/room/team_room.cpp`, and team protobuf schemas | `skills/team/SKILL.md`, `../src/lobbysvr/service/logic/team/USER_TEAM_TEST_PLAN.md` | Team protocol, dirty flow, membership, or admission repair changed |
