...
| Lobby team integration and notifications | `../src/lobbysvr/service/logic/team/`, `../src/teamsvr/service/room/logic/room/team_room.cpp`, and team protobuf schemas | `skills/team/SKILL.md`, `../src/lobbysvr/service/logic/team/README.md` | Team protocol, dirty flow, membership, or admission repair changed |
...
| MCP integration (tgrep/CodeGraph wrappers, installer) | `../project/integration/mcp/Plan.md`, affected wrapper sources/tests, and `../project/integration/mcp/README.md` | `skills/mcp-integration-maintenance/SKILL.md` | Upstream pins, agent config formats, lifecycle, or installer behavior changed |
