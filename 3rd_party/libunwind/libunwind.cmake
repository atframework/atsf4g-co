...
macro(PROJECT_3RD_PARTY_LIBUNWIND_IMPORT)
  ...
  elseif(Libunwind_FOUND)
    ...
    # if (3RD_PARTY_LIBUNWIND_INC_DIR) list(APPEND 3RD_PARTY_PUBLIC_INCLUDE_DIRS
    # ${3RD_PARTY_LIBUNWIND_INC_DIR}) endif () list(APPEND 3RD_PARTY_PUBLIC_LINK_NAMES
    # ${3RD_PARTY_LIBUNWIND_LINK_NAME})
  else()
...
if(NOT TARGET Libunwind::libunwind AND NOT Libunwind_FOUND)
  set(3RD_PARTY_LIBUNWIND_DEFAULT_VERSION "v1.5")
  ...
  findconfigurepackage(
    ...
    BUILD_DIRECTORY
    "${CMAKE_CURRENT_BINARY_DIR}/deps/libunwind-${3RD_PARTY_LIBUNWIND_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
    PREFIX_DIRECTORY
    ${PROJECT_3RD_PARTY_INSTALL_DIR}
    SRC_DIRECTORY_NAME
    "libunwind-${3RD_PARTY_LIBUNWIND_DEFAULT_VERSION}"
    GIT_BRANCH
    ${3RD_PARTY_LIBUNWIND_DEFAULT_VERSION}
    GIT_URL
    ${3RD_PARTY_LIBUNWIND_REPO_URL})
