...
macro(PROJECT_3RD_PARTY_YAML_CPP_IMPORT)
  if(TARGET yaml-cpp::yaml-cpp)
    ...
    list(APPEND 3RD_PARTY_PUBLIC_LINK_NAMES ${3RD_PARTY_YAML_CPP_LINK_NAME})
  ...
  elseif(YAML_CPP_INCLUDE_DIR AND YAML_CPP_LIBRARIES)
    ...
    list(APPEND 3RD_PARTY_PUBLIC_INCLUDE_DIRS ${YAML_CPP_INCLUDE_DIR})
    list(APPEND 3RD_PARTY_PUBLIC_LINK_NAMES ${3RD_PARTY_YAML_CPP_LINK_NAME})
  endif()
endmacro()
...
if(NOT TARGET yaml-cpp::yaml-cpp
  ...
  findconfigurepackage(
    ...
    BUILD_DIRECTORY
    "${CMAKE_CURRENT_BINARY_DIR}/deps/yaml-cpp-${3RD_PARTY_YAML_CPP_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
    PREFIX_DIRECTORY
    "${PROJECT_3RD_PARTY_INSTALL_DIR}"
    SRC_DIRECTORY_NAME
    "yaml-cpp-${3RD_PARTY_YAML_CPP_DEFAULT_VERSION}"
    GIT_BRANCH
    "yaml-cpp-${3RD_PARTY_YAML_CPP_DEFAULT_VERSION}"
    GIT_URL
    "${3RD_PARTY_YAML_CPP_REPO_URL}")
