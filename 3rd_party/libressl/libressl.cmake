...
set (3RD_PARTY_LIBRESSL_DEFAULT_VERSION "3.0.2")
...
if (NOT LIBRESSL_FOUND)
    ...
    find_library(3RD_PARTY_LIBRESSL_FIND_LIB_CRYPTO NAMES crypto PATHS "${3RD_PARTY_LIBRESSL_ROOT_DIR}/lib" "${3RD_PARTY_LIBRESSL_ROOT_DIR}/lib64" NO_DEFAULT_PATH)
    find_library(3RD_PARTY_LIBRESSL_FIND_LIB_SSL NAMES ssl PATHS "${3RD_PARTY_LIBRESSL_ROOT_DIR}/lib" "${3RD_PARTY_LIBRESSL_ROOT_DIR}/lib64" NO_DEFAULT_PATH)
    find_library(3RD_PARTY_LIBRESSL_FIND_LIB_TLS NAMES tls PATHS "${3RD_PARTY_LIBRESSL_ROOT_DIR}/lib" "${3RD_PARTY_LIBRESSL_ROOT_DIR}/lib64" NO_DEFAULT_PATH)
