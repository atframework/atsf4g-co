...
if(NOT MSVC
   AND NOT MINGW
   AND (NOT 3RD_PARTY_JEMALLOC_INC_DIR OR NOT 3RD_PARTY_JEMALLOC_LIB_DIR))
  set(3RD_PARTY_JEMALLOC_PKG_VERSION 5.2.1)
  set(3RD_PARTY_JEMALLOC_MODE "release")

  # if ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug") set (3RD_PARTY_JEMALLOC_MODE "debug") endif()
  ...
  findconfigurepackage(
    ...
    "--enable-utrace"
    "--enable-munmap"
    ${3RD_PARTY_JEMALLOC_BUILD_OPTIONS}
    INSTALL_TARGET
    "install_bin"
    "install_include"
    "install_lib"
    ...
    BUILD_DIRECTORY
    "${PROJECT_3RD_PARTY_PACKAGE_DIR}/jemalloc-${3RD_PARTY_JEMALLOC_PKG_VERSION}"
    PREFIX_DIRECTORY
    ${PROJECT_3RD_PARTY_INSTALL_DIR}
    SRC_DIRECTORY_NAME
    "jemalloc-${3RD_PARTY_JEMALLOC_PKG_VERSION}"
    GIT_BRANCH
    ${3RD_PARTY_JEMALLOC_PKG_VERSION}
    GIT_URL
