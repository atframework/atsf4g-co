...
# if (VCPKG_TOOLCHAIN) find_package(hiredis QUIET) PROJECT_3RD_PARTY_REDIS_HIREDIS_IMPORT() endif ()
...
if(NOT TARGET hiredis::hiredis_ssl_static
  ...
  if(NOT 3RD_PARTY_REDIS_HIREDIS_VERSION)
    set(3RD_PARTY_REDIS_HIREDIS_VERSION "2a5a57b90a57af5142221aa71f38c08f4a737376") # v1.0.0 with
                                                                                    # some patch
  endif()
  set(3RD_PARTY_REDIS_HIREDIS_DIR
      "${PROJECT_3RD_PARTY_PACKAGE_DIR}/hiredis-${3RD_PARTY_REDIS_HIREDIS_VERSION}")
