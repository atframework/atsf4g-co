...
macro(PROJECT_3RD_PARTY_PROTOBUF_IMPORT)
  if(Protobuf_FOUND
    ...
    if(TARGET protobuf::libprotobuf AND TARGET protobuf::libprotobuf-lite)
      ...
      get_target_property(3RD_PARTY_PROTOBUF_INC_DIR protobuf::libprotobuf
...
# =========== 3rdparty protobuf ==================
if(NOT 3RD_PARTY_PROTOBUF_BIN_PROTOC OR (NOT 3RD_PARTY_PROTOBUF_LINK_NAME
                                         AND NOT 3RD_PARTY_PROTOBUF_INC_DIR))
  ...
  if(NOT Protobuf_FOUND
    ...
    set(3RD_PARTY_PROTOBUF_VERSION "3.15.6")
    ...
    if(PROTOBUF_HOST_ROOT)
      ...
      set(3RD_PARTY_PROTOBUF_HOST_ROOT_DIR
          "${PROJECT_3RD_PARTY_INSTALL_DIR}/../${PROJECT_PREBUILT_HOST_PLATFORM_NAME}")
    endif()
    ...
    if(CMAKE_VERSION VERSION_LESS "3.14"
       AND EXISTS "${3RD_PARTY_PROTOBUF_ROOT_DIR}/lib64"
       AND NOT EXISTS "${3RD_PARTY_PROTOBUF_ROOT_DIR}/lib")
      if(CMAKE_HOST_WIN32)
        execute_process(
          COMMAND mklink /D "${3RD_PARTY_PROTOBUF_ROOT_DIR}/lib"
                  "${3RD_PARTY_PROTOBUF_ROOT_DIR}/lib64"
    ...
    find_library(
      3RD_PARTY_PROTOBUF_FIND_LIB
      NAMES protobuf libprotobuf protobufd libprotobufd
      PATHS "${3RD_PARTY_PROTOBUF_ROOT_DIR}/lib" "${3RD_PARTY_PROTOBUF_ROOT_DIR}/lib64"
      NO_DEFAULT_PATH)
    if(NOT 3RD_PARTY_PROTOBUF_FIND_LIB)
      if(NOT EXISTS "${3RD_PARTY_PROTOBUF_PKG_DIR}/protobuf-${3RD_PARTY_PROTOBUF_VERSION}")
        if(NOT EXISTS
          ...
          findconfigurepackagedownloadfile(
            "https://github.com/google/protobuf/releases/download/v${3RD_PARTY_PROTOBUF_VERSION}/protobuf-all-${3RD_PARTY_PROTOBUF_VERSION}.tar.gz"
            "${3RD_PARTY_PROTOBUF_PKG_DIR}/protobuf-all-${3RD_PARTY_PROTOBUF_VERSION}.tar.gz")
        endif()
      ...
      list(
        ...
        ${CMAKE_COMMAND}
        "${3RD_PARTY_PROTOBUF_PKG_DIR}/protobuf-${3RD_PARTY_PROTOBUF_VERSION}/cmake"
      ...
      list(
        APPEND
        3RD_PARTY_PROTOBUF_HOST_BUILD_FLAGS
        ${CMAKE_COMMAND}
        "${3RD_PARTY_PROTOBUF_PKG_DIR}/protobuf-${3RD_PARTY_PROTOBUF_VERSION}/cmake"
        "-Dprotobuf_BUILD_TESTS=OFF"
        "-Dprotobuf_BUILD_EXAMPLES=OFF"
      ...
      set(3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR
          "${CMAKE_CURRENT_BINARY_DIR}/deps/protobuf-${3RD_PARTY_PROTOBUF_VERSION}")
      ...
      string(REGEX REPLACE ";" "\" \"" 3RD_PARTY_PROTOBUF_BUILD_FLAGS_CMD
                           "${3RD_PARTY_PROTOBUF_BUILD_FLAGS}")
      set(3RD_PARTY_PROTOBUF_BUILD_FLAGS_CMD "\"${3RD_PARTY_PROTOBUF_BUILD_FLAGS_CMD}\"")
      string(REGEX REPLACE ";" "\" \"" 3RD_PARTY_PROTOBUF_HOST_BUILD_FLAGS_CMD
                           "${3RD_PARTY_PROTOBUF_HOST_BUILD_FLAGS}")
      ...
      if(CMAKE_HOST_UNIX OR MSYS)
        ...
        configure_file(
          ...
          "${3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR}/run-build-release.sh" @ONLY NEWLINE_STYLE LF)

        # build
        execute_process(COMMAND bash "${3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR}/run-build-release.sh"
                        WORKING_DIRECTORY ${3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR})
      else()
        configure_file(
          "${CMAKE_CURRENT_LIST_DIR}/run-build-release.ps1.in"
          "${3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR}/run-build-release.ps1" @ONLY NEWLINE_STYLE CRLF)
        configure_file(
          "${CMAKE_CURRENT_LIST_DIR}/run-build-release.bat.in"
          "${3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR}/run-build-release.bat" @ONLY NEWLINE_STYLE CRLF)
        ...
        message(
          STATUS
            "@${3RD_PARTY_PROTOBUF_BUILD_SCRIPT_DIR} Run: ${3RD_PARTY_PROTOBUF_POWERSHELL_BIN} -NoProfile -InputFormat None -ExecutionPolicy Bypass -NonInteractive -NoLogo -File run-build-release.ps1"
        )
        execute_process(
          COMMAND
            ${3RD_PARTY_PROTOBUF_POWERSHELL_BIN} -NoProfile -InputFormat None -ExecutionPolicy
            Bypass -NonInteractive -NoLogo -File
    ...
    if(NOT PROJECT_PREBUILT_PLATFORM_NAME STREQUAL PROJECT_PREBUILT_HOST_PLATFORM_NAME)
      find_program(
        ...
        PATHS "${3RD_PARTY_PROTOBUF_HOST_ROOT_DIR}/${CMAKE_INSTALL_BINDIR}"
        NO_DEFAULT_PATH)
    endif()
    find_package(Protobuf QUIET)
    project_3rd_party_protobuf_import()
