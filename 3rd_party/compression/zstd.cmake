...
macro(PROJECT_3RD_PARTY_ZSTD_IMPORT)
  if(TARGET zstd::libzstd_shared)
    ...
    # list(APPEND 3RD_PARTY_PUBLIC_LINK_NAMES zstd::libzstd_shared)
  elseif(TARGET zstd::libzstd_static)
    set(3RD_PARTY_ZSTD_LINK_NAME zstd::libzstd_static)
    echowithcolor(COLOR GREEN
                  "-- Dependency(${PROJECT_NAME}): zstd found target: zstd::libzstd_static")
    # list(APPEND 3RD_PARTY_PUBLIC_LINK_NAMES zstd::libzstd_static)
  elseif(TARGET zstd::libzstd)
    ...
    # list(APPEND 3RD_PARTY_PUBLIC_LINK_NAMES zstd::libzstd)
  else()
  ...
  if(TARGET zstd::zstd)
    ...
    echowithcolor(COLOR GREEN
                  "-- Dependency(${PROJECT_NAME}): zstd found exec: ${3RD_PARTY_ZSTD_BIN}")
  ...
  if(3RD_PARTY_ZSTD_LINK_NAME)
    list(APPEND 3RD_PARTY_COPY_EXECUTABLE_PATTERN "${PROJECT_3RD_PARTY_INSTALL_DIR}/bin/zstd*")
  endif()
endmacro()
...
if(NOT TARGET zstd::libzstd_shared
  ...
  if(NOT TARGET zstd::libzstd_shared
     ...
     AND NOT TARGET zstd::libzstd
     AND NOT TARGET zstd::zstd)
    set(PROJECT_3RD_PARTY_ZSTD_DEFAULT_VERSION "v1.4.9")
    ...
    findconfigurepackage(
      ...
      "-DLZ4_ROOT_DIR=${PROJECT_3RD_PARTY_INSTALL_DIR}"
      "-DZLIB_ROOT=${PROJECT_3RD_PARTY_INSTALL_DIR}"
      WORKING_DIRECTORY
      "${PROJECT_3RD_PARTY_PACKAGE_DIR}"
      PREFIX_DIRECTORY
      "${PROJECT_3RD_PARTY_INSTALL_DIR}"
      SRC_DIRECTORY_NAME
      "zstd-${PROJECT_3RD_PARTY_ZSTD_DEFAULT_VERSION}"
      PROJECT_DIRECTORY
      "${PROJECT_3RD_PARTY_PACKAGE_DIR}/zstd-${PROJECT_3RD_PARTY_ZSTD_DEFAULT_VERSION}/build/cmake"
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/deps/zstd-${PROJECT_3RD_PARTY_ZSTD_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      GIT_BRANCH
      "${PROJECT_3RD_PARTY_ZSTD_DEFAULT_VERSION}"
      GIT_URL
