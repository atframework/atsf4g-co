...
if(NOT Libwebsockets_FOUND
  ...
  if(NOT Libwebsockets_FOUND
    ...
    if(NOT Libwebsockets_FOUND)
      ...
      set(3RD_PARTY_LIBWEBSOCKETS_REPO_DIR
          "${PROJECT_3RD_PARTY_PACKAGE_DIR}/libwebsockets-${3RD_PARTY_LIBWEBSOCKETS_VERSION}")
      set(3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR
          "${CMAKE_CURRENT_BINARY_DIR}/deps/libwebsockets-${3RD_PARTY_LIBWEBSOCKETS_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      )
      ...
      project_git_clone_3rd_party(
        ...
        REPO_DIRECTORY
        ${3RD_PARTY_LIBWEBSOCKETS_REPO_DIR}
        DEPTH
        200
        TAG
        ${3RD_PARTY_LIBWEBSOCKETS_VERSION}
        WORKING_DIRECTORY
      ...
      set(3RD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
          ${CMAKE_COMMAND}
          "${3RD_PARTY_LIBWEBSOCKETS_REPO_DIR}"
      ...
      if(NOT WIN32
         AND NOT CYGWIN
         AND NOT MINGW)
        list(APPEND 3RD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS "-DLWS_UNIX_SOCK=ON")
      endif()
      ...
      if(NOT MSVC)
        file(WRITE "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.sh"
             "#!/bin/bash${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
        file(WRITE "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.sh"
             "#!/bin/bash${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
        file(
          APPEND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.sh"
          "export PATH=\"${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}:\$PATH\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
        )
        file(
          APPEND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.sh"
          "export PATH=\"${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}:\$PATH\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
        )
        ...
        execute_process(COMMAND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.sh"
                        WORKING_DIRECTORY ${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR})

        execute_process(COMMAND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.sh"
                        WORKING_DIRECTORY ${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR})

      else()
        file(WRITE "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.bat"
             "@echo off${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
        file(WRITE "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.bat"
             "@echo off${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
        file(
          APPEND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.bat"
          "set PATH=${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR};%PATH%${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}"
        )
        file(
          APPEND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.bat"
          "set PATH=${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR};%PATH%${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}"
        )
        ...
        message(
          STATUS
            "@${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR} Run: ${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.bat"
        )
        message(
          STATUS
            "@${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR} Run: ${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.bat"
        )
        execute_process(COMMAND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-config.bat"
                        WORKING_DIRECTORY ${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR})

        execute_process(COMMAND "${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR}/run-build-release.bat"
                        WORKING_DIRECTORY ${3RD_PARTY_LIBWEBSOCKETS_BUILD_DIR})
      endif()
