...
if(NOT TARGET gRPC::grpc++_alts
  ...
  if(NOT TARGET gRPC::grpc++_alts
     AND NOT TARGET gRPC::grpc++
     AND NOT TARGET gRPC::grpc)
    set(3RD_PARTY_GRPC_DEFAULT_VERSION "v1.36.4")
    ...
    findconfigurepackage(
      ...
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/deps/grpc-${3RD_PARTY_GRPC_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      PREFIX_DIRECTORY
      "${PROJECT_3RD_PARTY_INSTALL_DIR}"
      SRC_DIRECTORY_NAME
      "grpc-${3RD_PARTY_GRPC_DEFAULT_VERSION}"
      GIT_BRANCH
      "${3RD_PARTY_GRPC_DEFAULT_VERSION}"
      GIT_URL
      "https://github.com/grpc/grpc.git")
