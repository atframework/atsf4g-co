...
if(NOT 3RD_PARTY_MBEDTLS_FOUND)
  set(3RD_PARTY_MBEDTLS_DEFAULT_VERSION "2.25.0")
  ...
  if(NOT 3RD_PARTY_MBEDTLS_FOUND)
    set(3RD_PARTY_MBEDTLS_CMAKE_OPTIONS "-DENABLE_TESTING=OFF" "-DUSE_STATIC_MBEDTLS_LIBRARY=ON" "-DUSE_SHARED_MBEDTLS_LIBRARY=OFF"
    ...
    findconfigurepackage(
      ...
      "mbedtls-${3RD_PARTY_MBEDTLS_DEFAULT_VERSION}"
      BUILD_DIRECTORY
      "${PROJECT_3RD_PARTY_PACKAGE_DIR}/mbedtls-${3RD_PARTY_MBEDTLS_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      PREFIX_DIRECTORY
