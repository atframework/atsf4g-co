...
if(NOT 3RD_PARTY_CRYPT_LINK_NAME)
  ...
  if(NOT LIBRESSL_FOUND)
    ...
    if(EXISTS "${PROJECT_3RD_PARTY_PACKAGE_DIR}/libressl-${3RD_PARTY_LIBRESSL_DEFAULT_VERSION}/CMakeCache.txt")
      execute_process(
        COMMAND ${CMAKE_COMMAND} -E remove_directory "${PROJECT_3RD_PARTY_PACKAGE_DIR}/libressl-${3RD_PARTY_LIBRESSL_DEFAULT_VERSION}"
    ...
    if(NOT EXISTS "${PROJECT_3RD_PARTY_PACKAGE_DIR}/libressl-${3RD_PARTY_LIBRESSL_DEFAULT_VERSION}")
      ...
      execute_process(
        COMMAND ${CMAKE_COMMAND} -E tar xvf "${PROJECT_3RD_PARTY_PACKAGE_DIR}/libressl-${3RD_PARTY_LIBRESSL_DEFAULT_VERSION}.tar.gz"
        WORKING_DIRECTORY ${PROJECT_3RD_PARTY_PACKAGE_DIR})
    endif()
    ...
    set(3RD_PARTY_LIBRESSL_BUILD_DIR
        "${PROJECT_3RD_PARTY_PACKAGE_DIR}/libressl-${3RD_PARTY_LIBRESSL_DEFAULT_VERSION}/build_jobs_dir_${PROJECT_PREBUILT_PLATFORM_NAME}")
    ...
    if(CMAKE_HOST_UNIX
      ...
      file(APPEND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh"
           "export PATH=\"${3RD_PARTY_LIBRESSL_BUILD_DIR}:\$PATH\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
      file(APPEND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.sh"
           "export PATH=\"${3RD_PARTY_LIBRESSL_BUILD_DIR}:\$PATH\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
      ...
      project_expand_list_for_command_line_to_file("${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh" ${3RD_PARTY_LIBRESSL_BUILD_FLAGS})
      ...
      execute_process(COMMAND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh" WORKING_DIRECTORY ${3RD_PARTY_LIBRESSL_BUILD_DIR})

      execute_process(COMMAND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.sh" WORKING_DIRECTORY ${3RD_PARTY_LIBRESSL_BUILD_DIR})
      ...
      project_expand_list_for_command_line_to_file("${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat" ${3RD_PARTY_LIBRESSL_BUILD_FLAGS})
      project_expand_list_for_command_line_to_file(
      ...
      execute_process(COMMAND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat" WORKING_DIRECTORY ${3RD_PARTY_LIBRESSL_BUILD_DIR})
      # install debug target
      if(MSVC)
        message(STATUS "@${3RD_PARTY_LIBRESSL_BUILD_DIR} Run: ${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat")
        execute_process(COMMAND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat" WORKING_DIRECTORY ${3RD_PARTY_LIBRESSL_BUILD_DIR})
      endif()

      execute_process(COMMAND "${3RD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.bat" WORKING_DIRECTORY ${3RD_PARTY_LIBRESSL_BUILD_DIR})
    endif()
