...
if(NOT TARGET lua::liblua-static AND NOT TARGET lua::liblua-dynamic)
  set(PROJECT_3RD_PARTY_LUA_VERSION "v5.4.3")
  set(PROJECT_3RD_PARTY_LUA_REPO_DIR
      "${PROJECT_3RD_PARTY_PACKAGE_DIR}/lua-${PROJECT_3RD_PARTY_LUA_VERSION}")
  set(PROJECT_3RD_PARTY_LUA_REPO_URL "https://github.com/lua/lua.git")
  set(PROJECT_3RD_PARTY_LUA_BUILD_DIR
      "${CMAKE_BINARY_DIR}/deps/lua-${PROJECT_3RD_PARTY_LUA_VERSION}")
  ...
  project_git_clone_3rd_party(
    URL
    ${PROJECT_3RD_PARTY_LUA_REPO_URL}
    REPO_DIRECTORY
    ${PROJECT_3RD_PARTY_LUA_REPO_DIR}
    DEPTH
    200
    BRANCH
    ${PROJECT_3RD_PARTY_LUA_VERSION}
    WORKING_DIRECTORY
