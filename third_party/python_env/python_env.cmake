...
if(EXISTS "${CMAKE_CURRENT_BINARY_DIR}/_deps/python_env/${PROJECT_PREBUILT_PLATFORM_NAME}/update-time.txt")
  file(READ "${CMAKE_CURRENT_BINARY_DIR}/_deps/python_env/${PROJECT_PREBUILT_PLATFORM_NAME}/update-time.txt"
...
if(PROJECT_THIRD_PARTY_PYTHON_ENV_NEED_UPDATE)
  ...
  if(PROJECT_THIRD_PARTY_PYTHON_ENV_UPDATE_RESULT EQUAL 0)
    file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/_deps/python_env/${PROJECT_PREBUILT_PLATFORM_NAME}/update-time.txt"
