...
class random_engine {
 private:
  ...
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API atfw::util::random::mt19937_64 &_get_common_generator();
 ...
 public:
  ...
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API_HEAD_ONLY void init_generator_with_seed(
   ...
   */
  template <typename RandomType>
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API_HEAD_ONLY void init_generator(RandomType &rnd) {
   ...
   * @return 随机数
   */
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API uint64_t random();
  ...
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API_HEAD_ONLY ResType random_between(ResType lowest, ResType highest) {
   ...
   * @return 随机数
   */
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API uint64_t fast_random();
   ...
   */
  template <typename ResType>
  static ATFRAMEWORK_SERVICE_COMPONENT_MACRO_API_HEAD_ONLY ResType fast_random_between(ResType lowest,
                                                                                       ResType highest) {
