...
class atgateway_listen_cfg final :
 ...
 public:
  ...
  atgateway_listen_cfg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint64_t max_client() const;
  void set_max_client(uint64_t value);
  private:
  uint64_t _internal_max_client() const;
  void _internal_set_max_client(uint64_t value);
  public:

  // int32 backlog = 4 [(.atapp.protocol.CONFIGURE) = {
  void clear_backlog();
  int32_t backlog() const;
  void set_backlog(int32_t value);
  private:
  int32_t _internal_backlog() const;
  void _internal_set_backlog(int32_t value);
  public:
...
class atgateway_client_limit_cfg final :
 ...
 public:
  ...
  atgateway_client_limit_cfg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint64_t total_send_bytes() const;
  void set_total_send_bytes(uint64_t value);
  private:
  uint64_t _internal_total_send_bytes() const;
  void _internal_set_total_send_bytes(uint64_t value);
  public:

  // uint64 total_recv_bytes = 2 [(.atapp.protocol.CONFIGURE) = {
  void clear_total_recv_bytes();
  uint64_t total_recv_bytes() const;
  void set_total_recv_bytes(uint64_t value);
  private:
  uint64_t _internal_total_recv_bytes() const;
  void _internal_set_total_recv_bytes(uint64_t value);
  public:

  // uint64 hour_send_bytes = 3 [(.atapp.protocol.CONFIGURE) = {
  void clear_hour_send_bytes();
  uint64_t hour_send_bytes() const;
  void set_hour_send_bytes(uint64_t value);
  private:
  uint64_t _internal_hour_send_bytes() const;
  void _internal_set_hour_send_bytes(uint64_t value);
  public:

  // uint64 hour_recv_bytes = 4 [(.atapp.protocol.CONFIGURE) = {
  void clear_hour_recv_bytes();
  uint64_t hour_recv_bytes() const;
  void set_hour_recv_bytes(uint64_t value);
  private:
  uint64_t _internal_hour_recv_bytes() const;
  void _internal_set_hour_recv_bytes(uint64_t value);
  public:

  // uint64 minute_send_bytes = 5 [(.atapp.protocol.CONFIGURE) = {
  void clear_minute_send_bytes();
  uint64_t minute_send_bytes() const;
  void set_minute_send_bytes(uint64_t value);
  private:
  uint64_t _internal_minute_send_bytes() const;
  void _internal_set_minute_send_bytes(uint64_t value);
  public:

  // uint64 minute_recv_bytes = 6 [(.atapp.protocol.CONFIGURE) = {
  void clear_minute_recv_bytes();
  uint64_t minute_recv_bytes() const;
  void set_minute_recv_bytes(uint64_t value);
  private:
  uint64_t _internal_minute_recv_bytes() const;
  void _internal_set_minute_recv_bytes(uint64_t value);
  public:

  // uint64 total_send_times = 7;
  void clear_total_send_times();
  uint64_t total_send_times() const;
  void set_total_send_times(uint64_t value);
  private:
  uint64_t _internal_total_send_times() const;
  void _internal_set_total_send_times(uint64_t value);
  public:

  // uint64 total_recv_times = 8;
  void clear_total_recv_times();
  uint64_t total_recv_times() const;
  void set_total_recv_times(uint64_t value);
  private:
  uint64_t _internal_total_recv_times() const;
  void _internal_set_total_recv_times(uint64_t value);
  public:

  // uint64 hour_send_times = 9;
  void clear_hour_send_times();
  uint64_t hour_send_times() const;
  void set_hour_send_times(uint64_t value);
  private:
  uint64_t _internal_hour_send_times() const;
  void _internal_set_hour_send_times(uint64_t value);
  public:

  // uint64 hour_recv_times = 10;
  void clear_hour_recv_times();
  uint64_t hour_recv_times() const;
  void set_hour_recv_times(uint64_t value);
  private:
  uint64_t _internal_hour_recv_times() const;
  void _internal_set_hour_recv_times(uint64_t value);
  public:

  // uint64 minute_send_times = 11;
  void clear_minute_send_times();
  uint64_t minute_send_times() const;
  void set_minute_send_times(uint64_t value);
  private:
  uint64_t _internal_minute_send_times() const;
  void _internal_set_minute_send_times(uint64_t value);
  public:

  // uint64 minute_recv_times = 12;
  void clear_minute_recv_times();
  uint64_t minute_recv_times() const;
  void set_minute_recv_times(uint64_t value);
  private:
  uint64_t _internal_minute_recv_times() const;
  void _internal_set_minute_recv_times(uint64_t value);
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  uint64_t total_send_bytes_;
  uint64_t total_recv_bytes_;
  uint64_t hour_send_bytes_;
  uint64_t hour_recv_bytes_;
  uint64_t minute_send_bytes_;
  uint64_t minute_recv_bytes_;
  uint64_t total_send_times_;
  uint64_t total_recv_times_;
  uint64_t hour_send_times_;
  uint64_t hour_recv_times_;
  uint64_t minute_send_times_;
  uint64_t minute_recv_times_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_libatgw_5fserver_5fconfig_2eproto;
};
// -------------------------------------------------------------------
...
class atgateway_client_crypt_cfg final :
 ...
 public:
  ...
  atgateway_client_crypt_cfg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD std::string* release_dhparam();
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Duration* release_update_interval();
...
class atgateway_client_cfg final :
 ...
 public:
  ...
  atgateway_client_cfg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Duration* release_reconnect_timeout();
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Duration* release_first_idle_timeout();
  ...
  PROTOBUF_NODISCARD ::atframe::gw::atgateway_client_limit_cfg* release_limit();
  ...
  PROTOBUF_NODISCARD ::atframe::gw::atgateway_client_crypt_cfg* release_crypt();
  ...
  void set_send_buffer_size(uint64_t value);
  private:
  uint64_t _internal_send_buffer_size() const;
  void _internal_set_send_buffer_size(uint64_t value);
  public:

  // uint64 default_router = 4;
  void clear_default_router();
  uint64_t default_router() const;
  void set_default_router(uint64_t value);
  private:
  uint64_t _internal_default_router() const;
  void _internal_set_default_router(uint64_t value);
  public:
 ...
 private:
  ...
  uint64_t send_buffer_size_;
  uint64_t default_router_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_libatgw_5fserver_5fconfig_2eproto;
};
// -------------------------------------------------------------------
...
class atgateway_cfg final :
 ...
 public:
  ...
  atgateway_cfg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::atframe::gw::atgateway_listen_cfg* release_listen();
  ...
  PROTOBUF_NODISCARD ::atframe::gw::atgateway_client_cfg* release_client();
...
inline uint64_t atgateway_listen_cfg::_internal_max_client() const {
  return max_client_;
}
inline uint64_t atgateway_listen_cfg::max_client() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_listen_cfg.max_client)
  return _internal_max_client();
}
inline void atgateway_listen_cfg::_internal_set_max_client(uint64_t value) {
  
  max_client_ = value;
}
inline void atgateway_listen_cfg::set_max_client(uint64_t value) {
...
inline int32_t atgateway_listen_cfg::_internal_backlog() const {
  return backlog_;
}
inline int32_t atgateway_listen_cfg::backlog() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_listen_cfg.backlog)
  return _internal_backlog();
}
inline void atgateway_listen_cfg::_internal_set_backlog(int32_t value) {
  
  backlog_ = value;
}
inline void atgateway_listen_cfg::set_backlog(int32_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_total_send_bytes() const {
  return total_send_bytes_;
}
inline uint64_t atgateway_client_limit_cfg::total_send_bytes() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.total_send_bytes)
  return _internal_total_send_bytes();
}
inline void atgateway_client_limit_cfg::_internal_set_total_send_bytes(uint64_t value) {
  
  total_send_bytes_ = value;
}
inline void atgateway_client_limit_cfg::set_total_send_bytes(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_total_recv_bytes() const {
  return total_recv_bytes_;
}
inline uint64_t atgateway_client_limit_cfg::total_recv_bytes() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.total_recv_bytes)
  return _internal_total_recv_bytes();
}
inline void atgateway_client_limit_cfg::_internal_set_total_recv_bytes(uint64_t value) {
  
  total_recv_bytes_ = value;
}
inline void atgateway_client_limit_cfg::set_total_recv_bytes(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_hour_send_bytes() const {
  return hour_send_bytes_;
}
inline uint64_t atgateway_client_limit_cfg::hour_send_bytes() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.hour_send_bytes)
  return _internal_hour_send_bytes();
}
inline void atgateway_client_limit_cfg::_internal_set_hour_send_bytes(uint64_t value) {
  
  hour_send_bytes_ = value;
}
inline void atgateway_client_limit_cfg::set_hour_send_bytes(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_hour_recv_bytes() const {
  return hour_recv_bytes_;
}
inline uint64_t atgateway_client_limit_cfg::hour_recv_bytes() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.hour_recv_bytes)
  return _internal_hour_recv_bytes();
}
inline void atgateway_client_limit_cfg::_internal_set_hour_recv_bytes(uint64_t value) {
  
  hour_recv_bytes_ = value;
}
inline void atgateway_client_limit_cfg::set_hour_recv_bytes(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_minute_send_bytes() const {
  return minute_send_bytes_;
}
inline uint64_t atgateway_client_limit_cfg::minute_send_bytes() const {
...
inline void atgateway_client_limit_cfg::_internal_set_minute_send_bytes(uint64_t value) {
  
  minute_send_bytes_ = value;
}
inline void atgateway_client_limit_cfg::set_minute_send_bytes(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_minute_recv_bytes() const {
  return minute_recv_bytes_;
}
inline uint64_t atgateway_client_limit_cfg::minute_recv_bytes() const {
...
inline void atgateway_client_limit_cfg::_internal_set_minute_recv_bytes(uint64_t value) {
  
  minute_recv_bytes_ = value;
}
inline void atgateway_client_limit_cfg::set_minute_recv_bytes(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_total_send_times() const {
  return total_send_times_;
}
inline uint64_t atgateway_client_limit_cfg::total_send_times() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.total_send_times)
  return _internal_total_send_times();
}
inline void atgateway_client_limit_cfg::_internal_set_total_send_times(uint64_t value) {
  
  total_send_times_ = value;
}
inline void atgateway_client_limit_cfg::set_total_send_times(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_total_recv_times() const {
  return total_recv_times_;
}
inline uint64_t atgateway_client_limit_cfg::total_recv_times() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.total_recv_times)
  return _internal_total_recv_times();
}
inline void atgateway_client_limit_cfg::_internal_set_total_recv_times(uint64_t value) {
  
  total_recv_times_ = value;
}
inline void atgateway_client_limit_cfg::set_total_recv_times(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_hour_send_times() const {
  return hour_send_times_;
}
inline uint64_t atgateway_client_limit_cfg::hour_send_times() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.hour_send_times)
  return _internal_hour_send_times();
}
inline void atgateway_client_limit_cfg::_internal_set_hour_send_times(uint64_t value) {
  
  hour_send_times_ = value;
}
inline void atgateway_client_limit_cfg::set_hour_send_times(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_hour_recv_times() const {
  return hour_recv_times_;
}
inline uint64_t atgateway_client_limit_cfg::hour_recv_times() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_limit_cfg.hour_recv_times)
  return _internal_hour_recv_times();
}
inline void atgateway_client_limit_cfg::_internal_set_hour_recv_times(uint64_t value) {
  
  hour_recv_times_ = value;
}
inline void atgateway_client_limit_cfg::set_hour_recv_times(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_minute_send_times() const {
  return minute_send_times_;
}
inline uint64_t atgateway_client_limit_cfg::minute_send_times() const {
...
inline void atgateway_client_limit_cfg::_internal_set_minute_send_times(uint64_t value) {
  
  minute_send_times_ = value;
}
inline void atgateway_client_limit_cfg::set_minute_send_times(uint64_t value) {
...
inline uint64_t atgateway_client_limit_cfg::_internal_minute_recv_times() const {
  return minute_recv_times_;
}
inline uint64_t atgateway_client_limit_cfg::minute_recv_times() const {
...
inline void atgateway_client_limit_cfg::_internal_set_minute_recv_times(uint64_t value) {
  
  minute_recv_times_ = value;
}
inline void atgateway_client_limit_cfg::set_minute_recv_times(uint64_t value) {
...
inline void atgateway_client_crypt_cfg::set_allocated_dhparam(std::string* dhparam) {
  ...
  dhparam_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), dhparam,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (dhparam_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline uint64_t atgateway_client_cfg::_internal_send_buffer_size() const {
  return send_buffer_size_;
}
inline uint64_t atgateway_client_cfg::send_buffer_size() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_cfg.send_buffer_size)
  return _internal_send_buffer_size();
}
inline void atgateway_client_cfg::_internal_set_send_buffer_size(uint64_t value) {
  
  send_buffer_size_ = value;
}
inline void atgateway_client_cfg::set_send_buffer_size(uint64_t value) {
...
inline uint64_t atgateway_client_cfg::_internal_default_router() const {
  return default_router_;
}
inline uint64_t atgateway_client_cfg::default_router() const {
  // @@protoc_insertion_point(field_get:atframe.gw.atgateway_client_cfg.default_router)
  return _internal_default_router();
}
inline void atgateway_client_cfg::_internal_set_default_router(uint64_t value) {
  
  default_router_ = value;
}
inline void atgateway_client_cfg::set_default_router(uint64_t value) {
