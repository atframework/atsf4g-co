...
int libatgw_proto_inner_v1::dispatch_handshake_start_req(
...
int libatgw_proto_inner_v1::dispatch_handshake_start_rsp(
    const ::atframe::gw::inner::v1::cs_body_handshake &body_handshake) {
  // check switch type
  ...
  switch (handshake_.switch_secret_type) {
    ...
    case ::atframe::gw::inner::v1::switch_secret_t_EN_SST_ECDH: {
      ...
      ::atframe::gw::inner::v1::handshake_step_t next_step =
          (handshake_.switch_secret_type == ::atframe::gw::inner::v1::switch_secret_t_EN_SST_DH)
...
int libatgw_proto_inner_v1::dispatch_handshake_reconn_req(
  ...
  reconn_body =
      Createcs_body_handshake(builder, sess_id, handshake_step_t_EN_HST_RECONNECT_RSP,
...
int libatgw_proto_inner_v1::dispatch_handshake_reconn_rsp(
    const ::atframe::gw::inner::v1::cs_body_handshake &body_handshake) {
...
int libatgw_proto_inner_v1::dispatch_handshake_dh_pubkey_req(
...
int libatgw_proto_inner_v1::dispatch_handshake_verify_ntf(
    const ::atframe::gw::inner::v1::cs_body_handshake &body_handshake) {
...
int libatgw_proto_inner_v1::pack_handshake_start_rsp(
  ...
  switch (handshake_.switch_secret_type) {
    case ::atframe::gw::inner::v1::switch_secret_t_EN_SST_DIRECT: {
      ...
      handshake_data = Createcs_body_handshake(
          builder, sess_id, handshake_step_t_EN_HST_START_RSP,
          static_cast< ::atframe::gw::inner::v1::switch_secret_t>(handshake_.switch_secret_type),
...
int libatgw_proto_inner_v1::pack_handshake_dh_pubkey_req(
    flatbuffers::FlatBufferBuilder &builder, const ::atframe::gw::inner::v1::cs_body_handshake &peer_body,
    flatbuffers::Offset< ::atframe::gw::inner::v1::cs_body_handshake> &handshake_data,
    ::atframe::gw::inner::v1::handshake_step_t next_step) {
  using namespace ::atframe::gw::inner::v1;
...
int libatgw_proto_inner_v1::try_write() {
  ...
  if (write_buffers_.limit().cost_number_ > 1 &&
      write_buffers_.front()->raw_size() <= ATFRAME_GATEWAY_MACRO_DATA_SMALL_SIZE) {
...
int libatgw_proto_inner_v1::reconnect_session(uint64_t sess_id, const std::string &crypt_type,
  ...
  handshake_body = Createcs_body_handshake(
      builder, sess_id, handshake_step_t_EN_HST_RECONNECT_REQ,
...
int libatgw_proto_inner_v1::send_post(::atframe::gw::inner::v1::cs_msg_type_t msg_type, const void *buffer,
                                      size_t len) {
  if (check_flag(flag_t::EN_PFT_CLOSING)) {
    return error_code_t::EN_ECT_CLOSING;
  }
  ...
  flatbuffers::FlatBufferBuilder builder;
  flatbuffers::Offset<cs_msg_head> header_data =
      Createcs_msg_head(builder, msg_type, ::atframe::gateway::detail::alloc_seq());
...
int libatgw_proto_inner_v1::send_ping() {
  ...
  flatbuffers::FlatBufferBuilder builder;
  flatbuffers::Offset<cs_msg_head> header_data =
      Createcs_msg_head(builder, cs_msg_type_t_EN_MTT_PING, ::atframe::gateway::detail::alloc_seq());
...
int libatgw_proto_inner_v1::send_pong(int64_t tp) {
  ...
  flatbuffers::FlatBufferBuilder builder;
  flatbuffers::Offset<cs_msg_head> header_data =
      Createcs_msg_head(builder, cs_msg_type_t_EN_MTT_PONG, ::atframe::gateway::detail::alloc_seq());
...
int libatgw_proto_inner_v1::send_kickoff(int reason) {
  ...
  flatbuffers::FlatBufferBuilder builder;
  flatbuffers::Offset<cs_msg_head> header_data =
      Createcs_msg_head(builder, cs_msg_type_t_EN_MTT_KICKOFF, ::atframe::gateway::detail::alloc_seq());
...
int libatgw_proto_inner_v1::send_verify(const void *buf, size_t sz) {
  ...
  flatbuffers::Offset<cs_body_handshake> verify_body =
      Createcs_body_handshake(builder, sess_id, handshake_step_t_EN_HST_VERIFY,
                              static_cast< ::atframe::gw::inner::v1::switch_secret_t>(handshake_.switch_secret_type),
                              builder.CreateString(std::string()),
