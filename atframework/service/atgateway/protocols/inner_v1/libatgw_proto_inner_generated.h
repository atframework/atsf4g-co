...
inline const error_code_t (&EnumValueserror_code_t())[6] {
  static const error_code_t values[] = {
      error_code_t_EN_ECT_REFUSE_RECONNECT, error_code_t_EN_ECT_SESSION_EXPIRED, error_code_t_EN_ECT_BUSY,
      error_code_t_EN_ECT_HANDSHAKE,        error_code_t_EN_ECT_FIRST_IDEL,      error_code_t_EN_ECT_SUCCESS};
  return values;
}

inline const char *EnumNameerror_code_t(error_code_t e) {
  switch (e) {
    case error_code_t_EN_ECT_REFUSE_RECONNECT:
      return "EN_ECT_REFUSE_RECONNECT";
    case error_code_t_EN_ECT_SESSION_EXPIRED:
      return "EN_ECT_SESSION_EXPIRED";
    case error_code_t_EN_ECT_BUSY:
      return "EN_ECT_BUSY";
    case error_code_t_EN_ECT_HANDSHAKE:
      return "EN_ECT_HANDSHAKE";
    case error_code_t_EN_ECT_FIRST_IDEL:
      return "EN_ECT_FIRST_IDEL";
    case error_code_t_EN_ECT_SUCCESS:
      return "EN_ECT_SUCCESS";
    default:
      return "";
  }
}
...
inline const handshake_step_t (&EnumValueshandshake_step_t())[9] {
  static const handshake_step_t values[] = {
      handshake_step_t_EN_HST_START_REQ,       handshake_step_t_EN_HST_START_RSP,
      handshake_step_t_EN_HST_RECONNECT_REQ,   handshake_step_t_EN_HST_RECONNECT_RSP,
      handshake_step_t_EN_HST_DH_PUBKEY_REQ,   handshake_step_t_EN_HST_DH_PUBKEY_RSP,
      handshake_step_t_EN_HST_ECDH_PUBKEY_REQ, handshake_step_t_EN_HST_ECDH_PUBKEY_RSP,
...
inline const switch_secret_t (&EnumValuesswitch_secret_t())[3] {
  static const switch_secret_t values[] = {switch_secret_t_EN_SST_DIRECT, switch_secret_t_EN_SST_DH,
                                           switch_secret_t_EN_SST_ECDH};
  return values;
}

inline const char *const *EnumNamesswitch_secret_t() {
  static const char *const names[4] = {"EN_SST_DIRECT", "EN_SST_DH", "EN_SST_ECDH", nullptr};
  return names;
}
...
inline const cs_msg_type_t (&EnumValuescs_msg_type_t())[8] {
  static const cs_msg_type_t values[] = {cs_msg_type_t_EN_MTT_UNKNOWN,      cs_msg_type_t_EN_MTT_POST,
                                         cs_msg_type_t_EN_MTT_HANDSHAKE,    cs_msg_type_t_EN_MTT_PING,
                                         cs_msg_type_t_EN_MTT_PONG,         cs_msg_type_t_EN_MTT_KICKOFF,
                                         cs_msg_type_t_EN_MTT_POST_KEY_SYN, cs_msg_type_t_EN_MTT_POST_KEY_ACK};
  return values;
}

inline const char *const *EnumNamescs_msg_type_t() {
  static const char *const names[9] = {"EN_MTT_UNKNOWN",      "EN_MTT_POST",         "EN_MTT_HANDSHAKE",
                                       "EN_MTT_PING",         "EN_MTT_PONG",         "EN_MTT_KICKOFF",
                                       "EN_MTT_POST_KEY_SYN", "EN_MTT_POST_KEY_ACK", nullptr};
  return names;
}
...
inline const cs_msg_body (&EnumValuescs_msg_body())[5] {
  static const cs_msg_body values[] = {cs_msg_body_NONE, cs_msg_body_cs_body_post, cs_msg_body_cs_body_kickoff,
                                       cs_msg_body_cs_body_ping, cs_msg_body_cs_body_handshake};
  return values;
}

inline const char *const *EnumNamescs_msg_body() {
  static const char *const names[6] = {"NONE",         "cs_body_post",      "cs_body_kickoff",
                                       "cs_body_ping", "cs_body_handshake", nullptr};
  return names;
}
...
template <typename T>
struct cs_msg_bodyTraits {
  static const cs_msg_body enum_value = cs_msg_body_NONE;
};

template <>
struct cs_msg_bodyTraits<atframe::gw::inner::v1::cs_body_post> {
  static const cs_msg_body enum_value = cs_msg_body_cs_body_post;
};

template <>
struct cs_msg_bodyTraits<atframe::gw::inner::v1::cs_body_kickoff> {
  static const cs_msg_body enum_value = cs_msg_body_cs_body_kickoff;
};

template <>
struct cs_msg_bodyTraits<atframe::gw::inner::v1::cs_body_ping> {
  static const cs_msg_body enum_value = cs_msg_body_cs_body_ping;
};

template <>
struct cs_msg_bodyTraits<atframe::gw::inner::v1::cs_body_handshake> {
...
bool Verifycs_msg_bodyVector(flatbuffers::Verifier &verifier,
                             const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
                             const flatbuffers::Vector<uint8_t> *types);

struct cs_msg_head FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef cs_msg_headBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TYPE = 4, VT_SEQUENCE = 6 };
  ...
  bool mutate_sequence(uint64_t _sequence) { return SetField<uint64_t>(VT_SEQUENCE, _sequence, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_TYPE) &&
           VerifyField<uint64_t>(verifier, VT_SEQUENCE) && verifier.EndTable();
  }
};
...
struct cs_msg_headBuilder {
  ...
  explicit cs_msg_headBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct cs_body_post FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_LENGTH = 4, VT_DATA = 6 };
  /// the length before encrypt, because encrypt data will pad data.
  uint64_t length() const { return GetField<uint64_t>(VT_LENGTH, 0); }
  bool mutate_length(uint64_t _length) { return SetField<uint64_t>(VT_LENGTH, _length, 0); }
  const flatbuffers::Vector<int8_t> *data() const { return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_DATA); }
  flatbuffers::Vector<int8_t> *mutable_data() { return GetPointer<flatbuffers::Vector<int8_t> *>(VT_DATA); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<uint64_t>(verifier, VT_LENGTH) &&
...
struct cs_body_postBuilder {
  ...
  explicit cs_body_postBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<cs_body_post> Createcs_body_post(flatbuffers::FlatBufferBuilder &_fbb, uint64_t length = 0,
...
inline flatbuffers::Offset<cs_body_post> Createcs_body_postDirect(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return atframe::gw::inner::v1::Createcs_body_post(_fbb, length, data__);
}

struct cs_body_kickoff FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef cs_body_kickoffBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_REASON = 4 };
  int32_t reason() const { return GetField<int32_t>(VT_REASON, 0); }
  bool mutate_reason(int32_t _reason) { return SetField<int32_t>(VT_REASON, _reason, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_REASON) && verifier.EndTable();
  }
};
...
struct cs_body_kickoffBuilder {
  ...
  explicit cs_body_kickoffBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
///     step=EN_HST_START_RSP, switch_type=EN_SST_DH                            : DH Parameters: P,G,GX (GX means G^X
///     and pub_key in openssl). KeyExchangeData as in SSL3 step=EN_HST_DH_PUBKEY_REQ|EN_HST_ECDH_PUBKEY_REQ,
///     switch_type=EN_SST_DH : DH public key of client step=EN_HST_DH_PUBKEY_RSP|EN_HST_ECDH_PUBKEY_RSP,
///     switch_type=EN_SST_DH : verify data prefix step=EN_HST_START_RSP, switch_type=EN_SST_DIRECT : secret
...
struct cs_body_handshake FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_session_id(uint64_t _session_id) { return SetField<uint64_t>(VT_SESSION_ID, _session_id, 0); }
  ...
  const flatbuffers::String *crypt_type() const { return GetPointer<const flatbuffers::String *>(VT_CRYPT_TYPE); }
  flatbuffers::String *mutable_crypt_type() { return GetPointer<flatbuffers::String *>(VT_CRYPT_TYPE); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<uint64_t>(verifier, VT_SESSION_ID) &&
           VerifyField<uint8_t>(verifier, VT_STEP) && VerifyField<uint8_t>(verifier, VT_SWITCH_TYPE) &&
           VerifyOffset(verifier, VT_CRYPT_TYPE) && verifier.VerifyString(crypt_type()) &&
           VerifyOffset(verifier, VT_CRYPT_PARAM) && verifier.VerifyVector(crypt_param()) &&
           VerifyOffset(verifier, VT_SWITCH_PARAM) && verifier.VerifyVector(switch_param()) && verifier.EndTable();
  }
};
...
struct cs_body_handshakeBuilder {
  ...
  explicit cs_body_handshakeBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<cs_body_handshake> Createcs_body_handshake(
    flatbuffers::FlatBufferBuilder &_fbb, uint64_t session_id = 0,
...
inline flatbuffers::Offset<cs_body_handshake> Createcs_body_handshakeDirect(
    ...
    atframe::gw::inner::v1::handshake_step_t step = atframe::gw::inner::v1::handshake_step_t_EN_HST_START_REQ,
    atframe::gw::inner::v1::switch_secret_t switch_type = atframe::gw::inner::v1::switch_secret_t_EN_SST_DIRECT,
    const char *crypt_type = nullptr, const std::vector<int8_t> *crypt_param = nullptr,
  ...
  return atframe::gw::inner::v1::Createcs_body_handshake(_fbb, session_id, step, switch_type, crypt_type__,
                                                         crypt_param__, switch_param__);
}

struct cs_body_ping FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef cs_body_pingBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_TIMEPOINT = 4 };
  /// the time when start ping
  int64_t timepoint() const { return GetField<int64_t>(VT_TIMEPOINT, 0); }
  bool mutate_timepoint(int64_t _timepoint) { return SetField<int64_t>(VT_TIMEPOINT, _timepoint, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int64_t>(verifier, VT_TIMEPOINT) && verifier.EndTable();
  }
};
...
struct cs_body_pingBuilder {
  ...
  explicit cs_body_pingBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct cs_msg FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_HEAD = 4, VT_BODY_TYPE = 6, VT_BODY = 8 };
  ...
  const atframe::gw::inner::v1::cs_body_post *body_as_cs_body_post() const {
    return body_type() == atframe::gw::inner::v1::cs_msg_body_cs_body_post
               ? static_cast<const atframe::gw::inner::v1::cs_body_post *>(body())
               : nullptr;
  }
  const atframe::gw::inner::v1::cs_body_kickoff *body_as_cs_body_kickoff() const {
    return body_type() == atframe::gw::inner::v1::cs_msg_body_cs_body_kickoff
               ? static_cast<const atframe::gw::inner::v1::cs_body_kickoff *>(body())
               : nullptr;
  }
  const atframe::gw::inner::v1::cs_body_ping *body_as_cs_body_ping() const {
    return body_type() == atframe::gw::inner::v1::cs_msg_body_cs_body_ping
               ? static_cast<const atframe::gw::inner::v1::cs_body_ping *>(body())
               : nullptr;
  }
  const atframe::gw::inner::v1::cs_body_handshake *body_as_cs_body_handshake() const {
    return body_type() == atframe::gw::inner::v1::cs_msg_body_cs_body_handshake
               ? static_cast<const atframe::gw::inner::v1::cs_body_handshake *>(body())
               : nullptr;
  }
  void *mutable_body() { return GetPointer<void *>(VT_BODY); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_HEAD) && verifier.VerifyTable(head()) &&
           VerifyField<uint8_t>(verifier, VT_BODY_TYPE) && VerifyOffset(verifier, VT_BODY) &&
           Verifycs_msg_body(verifier, body(), body_type()) && verifier.EndTable();
  }
};

template <>
inline const atframe::gw::inner::v1::cs_body_post *cs_msg::body_as<atframe::gw::inner::v1::cs_body_post>() const {
  return body_as_cs_body_post();
}

template <>
inline const atframe::gw::inner::v1::cs_body_kickoff *cs_msg::body_as<atframe::gw::inner::v1::cs_body_kickoff>() const {
  return body_as_cs_body_kickoff();
}

template <>
inline const atframe::gw::inner::v1::cs_body_ping *cs_msg::body_as<atframe::gw::inner::v1::cs_body_ping>() const {
  return body_as_cs_body_ping();
}

template <>
inline const atframe::gw::inner::v1::cs_body_handshake *cs_msg::body_as<atframe::gw::inner::v1::cs_body_handshake>()
    const {
...
struct cs_msgBuilder {
  ...
  explicit cs_msgBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<cs_msg> Createcs_msg(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<atframe::gw::inner::v1::cs_msg_head> head = 0,
...
inline bool Verifycs_msg_bodyVector(flatbuffers::Verifier &verifier,
                                    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
                                    const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!Verifycs_msg_body(verifier, values->Get(i), types->GetEnum<cs_msg_body>(i))) {
      return false;
    }
  }
  return true;
...
inline cs_msg *GetMutablecs_msg(void *buf) { return flatbuffers::GetMutableRoot<cs_msg>(buf); }
...
inline bool VerifySizePrefixedcs_msgBuffer(flatbuffers::Verifier &verifier) {
...
inline void Finishcs_msgBuffer(flatbuffers::FlatBufferBuilder &fbb,
                               flatbuffers::Offset<atframe::gw::inner::v1::cs_msg> root) {
  fbb.Finish(root, cs_msgIdentifier());
}

inline void FinishSizePrefixedcs_msgBuffer(flatbuffers::FlatBufferBuilder &fbb,
                                           flatbuffers::Offset<atframe::gw::inner::v1::cs_msg> root) {
