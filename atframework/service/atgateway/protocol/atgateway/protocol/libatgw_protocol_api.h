...
enum class error_code_t : int32_t {
  ...
  kNotWriting = -1018,
  kCryptoAlgorithmNotSupported = -1019,
  kParam = -1020,
  kBadData = -1021,
  kInvalidSize = -1022,
  kNoData = -1023,
  kMalloc = -1024,
  kCompressionNotSupported = -1025,
  kCompressionOperation = -1026,
  kCryptoAlreadyInited = -1101,
  kCryptoVerify = -1102,
  kCryptoOperation = -1103,
  kCryptoReadDhparamFile = -1211,
  kCryptoInitDhparam = -1212,
  kCryptoReadRsaPubkey = -1221,
  kCryptoReadRsaPrikey = -1222,
};
