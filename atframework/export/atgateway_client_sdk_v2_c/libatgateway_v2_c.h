...
enum libatgateway_v2_c_error_code_t {
  ...
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_ALGORITHM_NOT_SUPPORTED = -1019,
  ...
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_COMPRESSION_NOT_SUPPORTED = -1025,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_COMPRESSION_OPERATION = -1026,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_ALREADY_INITED = -1101,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_VERIFY = -1102,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_OPERATION = -1103,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_READ_DHPARAM_FILE = -1211,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_INIT_DHPARAM = -1212,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_READ_RSA_PUBKEY = -1221,
  LIBATGATEWAY_V2_C_EN_ERROR_CODE_CRYPTO_READ_RSA_PRIKEY = -1222,
};
...
/// @brief Set write header offset (headspace reserved before message data)
